...
<qgis version="3.4.14-Madeira" minScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" simplifyLocal="1" simplifyDrawingHints="1" readOnly="0" styleCategories="AllStyleCategories" labelsEnabled="0" maxScale="0" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0">
  ...
  <fieldConfiguration>
    ...
    <field name="densidade">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              <Option type="QString" value="1" name="Alta"/>
              <Option type="QString" value="2" name="Baixa"/>
              <Option type="QString" value="95" name="Desconhecida"/>
            </Option>
          </Option>
        </config>
    ...
    <field name="tipomanguezal">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              <Option type="QString" value="95" name="Desconhecido"/>
              <Option type="QString" value="2" name="Manguezal"/>
              <Option type="QString" value="3" name="Manguezal tipo apicum"/>
              <Option type="QString" value="4" name="Manguezal tipo salgado"/>
            </Option>
          </Option>
        </config>
      </editWidget>
  ...
  <aliases>
    ...
    <alias index="5" field="antropizada" name=""/>
    <alias index="6" field="secundaria" name=""/>
    <alias index="7" field="densidade" name=""/>
    <alias index="8" field="tipomanguezal" name=""/>
  ...
  <defaults>
    ...
    <default applyOnUpdate="0" field="secundaria" expression=""/>
    <default applyOnUpdate="0" field="densidade" expression=""/>
    <default applyOnUpdate="0" field="tipomanguezal" expression=""/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" field="secundaria" constraints="1" notnull_strength="1" exp_strength="0"/>
    <constraint unique_strength="0" field="densidade" constraints="0" notnull_strength="0" exp_strength="0"/>
    <constraint unique_strength="0" field="tipomanguezal" constraints="0" notnull_strength="0" exp_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint desc="" exp="" field="secundaria"/>
    <constraint desc="" exp="" field="densidade"/>
    <constraint desc="" exp="" field="tipomanguezal"/>

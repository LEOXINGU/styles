...
<qgis version="3.4.14-Madeira" minScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" simplifyLocal="1" simplifyDrawingHints="1" readOnly="0" styleCategories="AllStyleCategories" labelsEnabled="0" maxScale="0" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0">
  ...
  <fieldConfiguration>
    ...
    <field name="tipocurvanivel">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              <Option type="QString" value="3" name="Auxiliar"/>
              <Option type="QString" value="1" name="Mestra"/>
              <Option type="QString" value="2" name="Normal"/>
            </Option>
          </Option>
        </config>
      </editWidget>
  ...
  <aliases>
    ...
    <alias index="2" field="cota" name=""/>
    <alias index="3" field="depressao" name=""/>
    <alias index="4" field="tipocurvanivel" name=""/>
  ...
  <defaults>
    ...
    <default applyOnUpdate="0" field="tipocurvanivel" expression=""/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" field="cota" constraints="1" notnull_strength="1" exp_strength="0"/>
    <constraint unique_strength="0" field="depressao" constraints="1" notnull_strength="1" exp_strength="0"/>
    <constraint unique_strength="0" field="tipocurvanivel" constraints="1" notnull_strength="1" exp_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint desc="" exp="" field="tipocurvanivel"/>

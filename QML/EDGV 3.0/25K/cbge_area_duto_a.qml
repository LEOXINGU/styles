...
<qgis version="3.4.14-Madeira" minScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" simplifyLocal="1" simplifyDrawingHints="1" readOnly="0" styleCategories="AllStyleCategories" labelsEnabled="0" maxScale="0" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0">
  ...
  <aliases>
    ...
    <alias index="4" field="areavalvulas" name=""/>
    <alias index="5" field="bombeamento" name=""/>
  ...
  <defaults>
    ...
    <default applyOnUpdate="0" field="areavalvulas" expression=""/>
    <default applyOnUpdate="0" field="bombeamento" expression=""/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" field="areavalvulas" constraints="0" notnull_strength="0" exp_strength="0"/>
    <constraint unique_strength="0" field="bombeamento" constraints="0" notnull_strength="0" exp_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint desc="" exp="" field="areavalvulas"/>
    <constraint desc="" exp="" field="bombeamento"/>

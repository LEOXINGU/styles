...
<qgis version="3.4.14-Madeira" minScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" simplifyLocal="1" simplifyDrawingHints="1" readOnly="0" styleCategories="AllStyleCategories" labelsEnabled="0" maxScale="0" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0">
        ...
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              ...
              <Option type="QString" value="3" name="Olho dágua"/>
              <Option type="QString" value="1" name="Poço"/>
              <Option type="QString" value="2" name="Poço artesiano"/>
            </Option>
          </Option>
        </config>
      </editWidget>
        ...
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              ...
              <Option type="QString" value="3" name="Mineral"/>
              <Option type="QString" value="2" name="Não potável"/>
              <Option type="QString" value="1" name="Potável"/>
              <Option type="QString" value="4" name="Salobra"/>
            </Option>
          </Option>
        </config>
      </editWidget>
  ...
  <aliases>
    ...
    <alias index="3" field="tipofontedagua" name=""/>
    <alias index="4" field="qualidagua" name=""/>
    <alias index="5" field="regime" name=""/>
  </aliases>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" field="tipofontedagua" constraints="1" notnull_strength="1" exp_strength="0"/>
    <constraint unique_strength="0" field="qualidagua" constraints="0" notnull_strength="0" exp_strength="0"/>
    <constraint unique_strength="0" field="regime" constraints="0" notnull_strength="0" exp_strength="0"/>
  </constraints>
  <constraintExpressions>
    <constraint desc="" exp="" field="id"/>
    <constraint desc="" exp="" field="nome"/>
    <constraint desc="" exp="" field="geometriaaproximada"/>
    <constraint desc="" exp="" field="tipofontedagua"/>
    <constraint desc="" exp="" field="qualidagua"/>

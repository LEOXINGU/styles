...
<qgis version="3.4.14-Madeira" minScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" simplifyLocal="1" simplifyDrawingHints="1" readOnly="0" styleCategories="AllStyleCategories" labelsEnabled="0" maxScale="0" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0">
  ...
  <aliases>
    ...
    <alias index="12" field="finalidade" name=""/>
    <alias index="13" field="pesosuportmaximo" name=""/>
    <alias index="14" field="largura" name=""/>
  ...
  <defaults>
    ...
    <default applyOnUpdate="0" field="pesosuportmaximo" expression=""/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" field="pesosuportmaximo" constraints="0" notnull_strength="0" exp_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint desc="" exp="" field="pesosuportmaximo"/>

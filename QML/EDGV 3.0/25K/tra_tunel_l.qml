...
<qgis version="3.4.14-Madeira" minScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" simplifyLocal="1" simplifyDrawingHints="1" readOnly="0" styleCategories="AllStyleCategories" labelsEnabled="0" maxScale="0" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0">
    ...
    <field name="tipotunel">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              <Option type="QString" value="2" name="Passagem subterrânea"/>
  ...
  <aliases>
    ...
    <alias index="10" field="nrfaixas" name=""/>
    <alias index="11" field="nrpistas" name=""/>
    <alias index="12" field="posicaopista" name=""/>
    <alias index="13" field="tipopavimentacao" name=""/>
    <alias index="14" field="altura" name=""/>
    <alias index="15" field="tipotunel" name=""/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" field="tipotunel" constraints="0" notnull_strength="0" exp_strength="0"/>

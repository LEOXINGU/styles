...
<qgis version="3.4.14-Madeira" minScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" simplifyLocal="1" simplifyDrawingHints="1" readOnly="0" styleCategories="AllStyleCategories" labelsEnabled="0" maxScale="0" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0">
  ...
  <aliases>
    ...
    <alias index="24" field="tipoedifcomunic" name=""/>
    <alias index="25" field="modalidade" name=""/>
    <alias index="26" field="id_assentamento_precario" name=""/>
    <alias index="27" field="id_complexo_habitacional" name=""/>
    <alias index="28" field="id_condominio" name=""/>
    <alias index="29" field="id_conjunto_habitacional" name=""/>
    <alias index="30" field="id_complexo_comunicacao" name=""/>
  </aliases>
  ...
  <defaults>
    ...
    <default applyOnUpdate="0" field="tipoedifcomunic" expression=""/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" field="tipoedifcomunic" constraints="1" notnull_strength="1" exp_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint desc="" exp="" field="tipoedifcomunic"/>

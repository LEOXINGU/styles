...
<qgis version="3.4.14-Madeira" minScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" simplifyLocal="1" simplifyDrawingHints="1" readOnly="0" styleCategories="AllStyleCategories" labelsEnabled="0" maxScale="0" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0">
  ...
  <fieldConfiguration>
    ...
    <field name="tiposumvert">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              <Option type="QString" value="1" name="Sumidouro"/>
              <Option type="QString" value="2" name="Vertedouro"/>
            </Option>
          </Option>
        </config>
      </editWidget>
    ...
    <field name="causa">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              <Option type="QString" value="2" name="Absorção"/>
              <Option type="QString" value="5" name="Canalização"/>
              <Option type="QString" value="95" name="Desconhecida"/>
              <Option type="QString" value="4" name="Gruta ou fenda"/>
            </Option>
          </Option>
        </config>
      </editWidget>
  ...
  <aliases>
    ...
    <alias index="3" field="tiposumvert" name=""/>
    <alias index="4" field="causa" name=""/>
  </aliases>
  ...
  <defaults>
    ...
    <default applyOnUpdate="0" field="tiposumvert" expression=""/>
    <default applyOnUpdate="0" field="causa" expression=""/>
  </defaults>
  <constraints>
    ...
    <constraint unique_strength="0" field="tiposumvert" constraints="1" notnull_strength="1" exp_strength="0"/>
    <constraint unique_strength="0" field="causa" constraints="1" notnull_strength="1" exp_strength="0"/>
  </constraints>
  <constraintExpressions>
    <constraint desc="" exp="" field="id"/>
    <constraint desc="" exp="" field="nome"/>
    <constraint desc="" exp="" field="geometriaaproximada"/>
    <constraint desc="" exp="" field="tiposumvert"/>
    <constraint desc="" exp="" field="causa"/>
  </constraintExpressions>
  <expressionfields/>
  <attributeactions/>

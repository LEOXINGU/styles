...
<qgis version="3.4.14-Madeira" minScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" simplifyLocal="1" simplifyDrawingHints="1" readOnly="0" styleCategories="AllStyleCategories" labelsEnabled="0" maxScale="0" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0">
  ...
  <fieldConfiguration>
    ...
    <field name="tipoposte">
      <editWidget type="ValueRelation">
        <config>
          <Option type="Map">
            <Option type="bool" value="true" name="AllowMulti"/>
            <Option type="bool" value="true" name="AllowNull"/>
            <Option type="QString" value="code in (2,3,4,5,95,99)" name="FilterExpression"/>
            <Option type="QString" value="code" name="Key"/>
            <Option type="QString" value="tipo_poste_bf85164a_1202_4ff4_8b56_9ae8f4453197" name="Layer"/>
  ...
  <aliases>
    ...
    <alias index="2" field="codident" name=""/>
    <alias index="3" field="matconstr" name=""/>
    <alias index="4" field="tipoposte" name=""/>
  </aliases>
  ...
  <defaults>
    ...
    <default applyOnUpdate="0" field="codident" expression=""/>
    <default applyOnUpdate="0" field="matconstr" expression=""/>
    <default applyOnUpdate="0" field="tipoposte" expression=""/>
  </defaults>
  <constraints>
    ...
    <constraint unique_strength="0" field="codident" constraints="0" notnull_strength="0" exp_strength="0"/>
    <constraint unique_strength="0" field="matconstr" constraints="0" notnull_strength="0" exp_strength="0"/>
    <constraint unique_strength="0" field="tipoposte" constraints="1" notnull_strength="1" exp_strength="0"/>
  </constraints>
  <constraintExpressions>
    <constraint desc="" exp="" field="id"/>
    <constraint desc="" exp="" field="geometriaaproximada"/>
    <constraint desc="" exp="" field="codident"/>
    <constraint desc="" exp="" field="matconstr"/>
    <constraint desc="" exp="" field="tipoposte"/>
  </constraintExpressions>
  <expressionfields/>
  <attributeactions/>

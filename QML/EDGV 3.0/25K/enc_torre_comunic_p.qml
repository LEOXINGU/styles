...
<qgis version="3.4.14-Madeira" minScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" simplifyLocal="1" simplifyDrawingHints="1" readOnly="0" styleCategories="AllStyleCategories" labelsEnabled="0" maxScale="0" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0">
  ...
  <fieldConfiguration>
    ...
    <field name="posicaoreledific">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              <Option type="QString" value="17" name="Adjacente à edificação"/>
              <Option type="QString" value="95" name="Desconhecido"/>
              <Option type="QString" value="14" name="Isolada"/>
              <Option type="QString" value="18" name="Sobre edificação"/>
            </Option>
          </Option>
        </config>
      </editWidget>
      ...
      <editWidget type="ValueRelation">
        <config>
          <Option type="Map">
            ...
            <Option type="QString" value="code in (1,2,3,4,5,95,99)" name="FilterExpression"/>
            <Option type="QString" value="code" name="Key"/>
            <Option type="QString" value="modalidade_ca5b4298_aab2_4046_8c4d_da7dc72ee6c0" name="Layer"/>
            <Option type="QString" value="code_name" name="Value"/>
          </Option>
        </config>
      </editWidget>
    </field>
    <field name="id_complexo_comunicacao">
      <editWidget type="">
        <config>
          <Option/>
        </config>
  ...
  <aliases>
    ...
    <alias index="5" field="posicaoreledific" name=""/>
    <alias index="6" field="ovgd" name=""/>
    <alias index="7" field="alturaestimada" name=""/>
    <alias index="8" field="modalidade" name=""/>
    <alias index="9" field="id_complexo_comunicacao" name=""/>
  </aliases>
  ...
  <defaults>
    ...
    <default applyOnUpdate="0" field="posicaoreledific" expression=""/>
    <default applyOnUpdate="0" field="ovgd" expression=""/>
    <default applyOnUpdate="0" field="alturaestimada" expression=""/>
    <default applyOnUpdate="0" field="modalidade" expression=""/>
    <default applyOnUpdate="0" field="id_complexo_comunicacao" expression=""/>
  </defaults>
  <constraints>
    ...
    <constraint unique_strength="0" field="posicaoreledific" constraints="0" notnull_strength="0" exp_strength="0"/>
    <constraint unique_strength="0" field="ovgd" constraints="0" notnull_strength="0" exp_strength="0"/>
    <constraint unique_strength="0" field="alturaestimada" constraints="0" notnull_strength="0" exp_strength="0"/>
    <constraint unique_strength="0" field="modalidade" constraints="1" notnull_strength="1" exp_strength="0"/>
    <constraint unique_strength="0" field="id_complexo_comunicacao" constraints="0" notnull_strength="0" exp_strength="0"/>
  </constraints>
  <constraintExpressions>
    ...
    <constraint desc="" exp="" field="posicaoreledific"/>
    <constraint desc="" exp="" field="ovgd"/>
    <constraint desc="" exp="" field="alturaestimada"/>
    <constraint desc="" exp="" field="modalidade"/>
    <constraint desc="" exp="" field="id_complexo_comunicacao"/>
  </constraintExpressions>
  <expressionfields/>
  <attributeactions/>

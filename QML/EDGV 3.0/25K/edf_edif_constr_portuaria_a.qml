...
<qgis version="3.4.14-Madeira" minScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" simplifyLocal="1" simplifyDrawingHints="1" readOnly="0" styleCategories="AllStyleCategories" labelsEnabled="0" maxScale="0" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0">
      ...
      <editWidget type="ValueRelation">
        <config>
          <Option type="Map">
            <Option type="bool" value="true" name="AllowMulti"/>
            <Option type="bool" value="true" name="AllowNull"/>
            <Option type="QString" value="code in (15,26,27,32,33,34,35,36,37,95,99)" name="FilterExpression"/>
            <Option type="QString" value="code" name="Key"/>
            <Option type="QString" value="tipo_edif_port_73f2cbfe_218a_462e_b381_1507039a5615" name="Layer"/>
            <Option type="QString" value="code_name" name="Value"/>
          </Option>
        </config>
      </editWidget>
  ...
  <aliases>
    ...
    <alias index="28" field="tipoedifport" name=""/>
    <alias index="29" field="jurisdicao" name=""/>
    <alias index="30" field="concessionaria" name=""/>
    <alias index="31" field="id_complexo_portuario" name=""/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" field="tipoedifport" constraints="1" notnull_strength="1" exp_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint desc="" exp="" field="tipoedifport"/>

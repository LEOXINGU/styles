...
<qgis version="3.4.14-Madeira" minScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" simplifyLocal="1" simplifyDrawingHints="1" readOnly="0" styleCategories="AllStyleCategories" labelsEnabled="0" maxScale="0" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0">
  ...
  <fieldConfiguration>
    ...
    <field name="tipofundeadouro">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              <Option type="QString" value="1" name="Com limite definido"/>
              <Option type="QString" value="95" name="Desconhecido"/>
              <Option type="QString" value="2" name="Sem limite definido"/>
            </Option>
          </Option>
        </config>
      </editWidget>
  ...
  <aliases>
    ...
    <alias index="3" field="tipofundeadouro" name=""/>
    <alias index="4" field="administracao" name=""/>
    <alias index="5" field="id_complexo_portuario" name=""/>
  </aliases>
  ...
  <defaults>
    ...
    <default applyOnUpdate="0" field="tipofundeadouro" expression=""/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" field="tipofundeadouro" constraints="1" notnull_strength="1" exp_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint desc="" exp="" field="tipofundeadouro"/>

...
<qgis version="3.4.14-Madeira" minScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" simplifyLocal="1" simplifyDrawingHints="1" readOnly="0" styleCategories="AllStyleCategories" labelsEnabled="0" maxScale="0" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0">
  ...
  <fieldConfiguration>
    ...
    <field name="tipoedifrelig">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              <Option type="QString" value="10" name="Administração"/>
              <Option type="QString" value="9" name="Capela mortuária"/>
              <Option type="QString" value="3" name="Centro"/>
              <Option type="QString" value="5" name="Convento"/>
              <Option type="QString" value="95" name="Desconhecido"/>
              <Option type="QString" value="1" name="Igreja"/>
              <Option type="QString" value="6" name="Mesquita"/>
              <Option type="QString" value="4" name="Mosteiro"/>
              <Option type="QString" value="99" name="Outros"/>
              <Option type="QString" value="7" name="Sinagoga"/>
              <Option type="QString" value="2" name="Templo"/>
              <Option type="QString" value="8" name="Terreiro "/>
            </Option>
          </Option>
        </config>
      </editWidget>
  ...
  <aliases>
    ...
    <alias index="28" field="tipoedifrelig" name=""/>
    <alias index="29" field="ensino" name=""/>
    <alias index="30" field="religiao" name=""/>
    <alias index="31" field="crista" name=""/>
  ...
  <defaults>
    ...
    <default applyOnUpdate="0" field="tipoedifrelig" expression=""/>
    <default applyOnUpdate="0" field="ensino" expression=""/>
    <default applyOnUpdate="0" field="religiao" expression=""/>
    <default applyOnUpdate="0" field="crista" expression=""/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" field="tipoedifrelig" constraints="1" notnull_strength="1" exp_strength="0"/>
    <constraint unique_strength="0" field="ensino" constraints="1" notnull_strength="1" exp_strength="0"/>
    <constraint unique_strength="0" field="religiao" constraints="0" notnull_strength="0" exp_strength="0"/>
    <constraint unique_strength="0" field="crista" constraints="1" notnull_strength="1" exp_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint desc="" exp="" field="tipoedifrelig"/>
    <constraint desc="" exp="" field="ensino"/>
    <constraint desc="" exp="" field="religiao"/>
    <constraint desc="" exp="" field="crista"/>

...
<qgis version="3.4.14-Madeira" minScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" simplifyLocal="1" simplifyDrawingHints="1" readOnly="0" styleCategories="AllStyleCategories" labelsEnabled="0" maxScale="0" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0">
  ...
  <fieldConfiguration>
    ...
    <field name="tipotravessiaped">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              <Option type="QString" value="95" name="Desconhecido"/>
              <Option type="QString" value="7" name="Passagem subterrânea"/>
              <Option type="QString" value="8" name="Passarela"/>
              <Option type="QString" value="10" name="Passarela em Área Úmida"/>
              <Option type="QString" value="9" name="Pinguela"/>
            </Option>
          </Option>
        </config>
      </editWidget>
  ...
  <aliases>
    ...
    <alias index="7" field="tipotravessiaped" name=""/>
    <alias index="8" field="largura" name=""/>
    <alias index="9" field="extensao" name=""/>
  ...
  <defaults>
    ...
    <default applyOnUpdate="0" field="tipotravessiaped" expression=""/>
  ...
  <constraints>
    ...
    <constraint unique_strength="1" field="nome" constraints="3" notnull_strength="1" exp_strength="0"/>
    ...
    <constraint unique_strength="0" field="tipotravessiaped" constraints="1" notnull_strength="1" exp_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint desc="" exp="" field="tipotravessiaped"/>

...
<qgis version="3.4.14-Madeira" minScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" simplifyLocal="1" simplifyDrawingHints="1" readOnly="0" styleCategories="AllStyleCategories" labelsEnabled="0" maxScale="0" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0">
  ...
  <fieldConfiguration>
        ...
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              ...
              <Option type="QString" value="6" name="Uso da UF"/>
              <Option type="QString" value="2" name="Uso da União"/>
              <Option type="QString" value="5" name="Uso do município"/>
            </Option>
          </Option>
        </config>
      </editWidget>
    ...
    <field name="tipoinstalmilitar">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              <Option type="QString" value="5" name="Aquartelamento"/>
              <Option type="QString" value="8" name="Base aérea"/>
              <Option type="QString" value="17" name="Base naval"/>
              <Option type="QString" value="6" name="Campo de instruçao"/>
              <Option type="QString" value="7" name="Campo de tiro"/>
              <Option type="QString" value="16" name="Capitânia dos portos"/>
              <Option type="QString" value="11" name="Delegacia de  serviço militar"/>
              <Option type="QString" value="95" name="Desconhecido"/>
              <Option type="QString" value="9" name="Distrito naval"/>
              <Option type="QString" value="10" name="Hotel de trânsito"/>
              <Option type="QString" value="99" name="Outros"/>
              <Option type="QString" value="15" name="Posto de policiamento rodoviário"/>
              <Option type="QString" value="14" name="Posto de policiamento urbano"/>
              <Option type="QString" value="13" name="Posto de vigilância"/>
              <Option type="QString" value="12" name="Quartel general"/>
            </Option>
          </Option>
        </config>
      </editWidget>
  ...
  <aliases>
    ...
    <alias index="28" field="tipousoedif" name=""/>
    <alias index="29" field="jurisdicao" name=""/>
    <alias index="30" field="tipoinstalmilitar" name=""/>
  ...
  <defaults>
    ...
    <default applyOnUpdate="0" field="tipoinstalmilitar" expression=""/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" field="tipoinstalmilitar" constraints="1" notnull_strength="1" exp_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint desc="" exp="" field="tipoinstalmilitar"/>

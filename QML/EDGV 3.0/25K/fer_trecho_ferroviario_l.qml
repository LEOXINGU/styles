...
<qgis version="3.4.14-Madeira" minScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" simplifyLocal="1" simplifyDrawingHints="1" readOnly="0" styleCategories="AllStyleCategories" labelsEnabled="0" maxScale="0" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0">
        ...
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              ...
              <Option type="QString" value="6" name="Trecho para aeromóvel"/>
              <Option type="QString" value="5" name="Trecho para bonde"/>
              <Option type="QString" value="8" name="Trecho para metrô"/>
              <Option type="QString" value="7" name="Trecho para trem"/>
            </Option>
          </Option>
        </config>
      </editWidget>
      ...
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              <Option type="QString" value="95" name="Desconhecida"/>
              <Option type="QString" value="3" name="Internacional"/>
              <Option type="QString" value="4" name="Larga"/>
              <Option type="QString" value="7" name="Mista internacional larga"/>
              <Option type="QString" value="6" name="Mista métrica  larga"/>
              <Option type="QString" value="5" name="Mista métrica internacional"/>
              <Option type="QString" value="2" name="Métrica"/>
            </Option>
          </Option>
        </config>
      </editWidget>
  ...
  <aliases>
    ...
    <alias index="3" field="codtrechoferrov" name=""/>
    <alias index="4" field="posicaorelativa" name=""/>
    <alias index="5" field="tipotrechoferrov" name=""/>
    <alias index="6" field="bitola" name=""/>
    <alias index="7" field="eletrificada" name=""/>
    <alias index="8" field="nrlinhas" name=""/>
    <alias index="9" field="jurisdicao" name=""/>
    <alias index="10" field="administracao" name=""/>
    <alias index="11" field="concessionaria" name=""/>
    <alias index="12" field="operacional" name=""/>
    <alias index="13" field="situacaofisica" name=""/>
    <alias index="14" field="cargasuportmaxima" name=""/>
    <alias index="15" field="emarruamento" name=""/>
    <alias index="16" field="lenght_otf" name=""/>
  </aliases>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" field="codtrechoferrov" constraints="0" notnull_strength="0" exp_strength="0"/>
    <constraint unique_strength="0" field="posicaorelativa" constraints="1" notnull_strength="1" exp_strength="0"/>
    <constraint unique_strength="0" field="tipotrechoferrov" constraints="1" notnull_strength="1" exp_strength="0"/>
    <constraint unique_strength="0" field="bitola" constraints="1" notnull_strength="1" exp_strength="0"/>
    <constraint unique_strength="0" field="eletrificada" constraints="1" notnull_strength="1" exp_strength="0"/>
    <constraint unique_strength="0" field="nrlinhas" constraints="1" notnull_strength="1" exp_strength="0"/>
    ...
    <constraint unique_strength="0" field="emarruamento" constraints="1" notnull_strength="1" exp_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint desc="" exp="" field="codtrechoferrov"/>
    <constraint desc="" exp="" field="posicaorelativa"/>
    <constraint desc="" exp="" field="tipotrechoferrov"/>
    <constraint desc="" exp="" field="bitola"/>
    <constraint desc="" exp="" field="eletrificada"/>
    <constraint desc="" exp="" field="nrlinhas"/>
    ...
    <constraint desc="" exp="" field="emarruamento"/>

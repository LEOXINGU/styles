...
<qgis version="3.4.14-Madeira" minScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" simplifyLocal="1" simplifyDrawingHints="1" readOnly="0" styleCategories="AllStyleCategories" labelsEnabled="0" maxScale="0" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0">
  ...
  <fieldConfiguration>
    ...
    <field name="tipotrechodrenagem">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              <Option type="QString" value="4" name="Curso dágua"/>
              <Option type="QString" value="5" name="Pluvial"/>
            </Option>
          </Option>
        </config>
      </editWidget>
    </field>
    <field name="navegavel">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
  ...
  <aliases>
    ...
    <alias index="3" field="tipotrechodrenagem" name=""/>
    <alias index="4" field="navegavel" name=""/>
    <alias index="5" field="larguramedia" name=""/>
    <alias index="6" field="regime" name=""/>
    <alias index="7" field="encoberto" name=""/>
  ...
  <defaults>
    ...
    <default applyOnUpdate="0" field="tipotrechodrenagem" expression=""/>
    <default applyOnUpdate="0" field="navegavel" expression=""/>
    <default applyOnUpdate="0" field="larguramedia" expression=""/>
    <default applyOnUpdate="0" field="regime" expression=""/>
    <default applyOnUpdate="0" field="encoberto" expression=""/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" field="tipotrechodrenagem" constraints="1" notnull_strength="1" exp_strength="0"/>
    <constraint unique_strength="0" field="navegavel" constraints="1" notnull_strength="1" exp_strength="0"/>
    <constraint unique_strength="0" field="larguramedia" constraints="0" notnull_strength="0" exp_strength="0"/>
    <constraint unique_strength="0" field="regime" constraints="1" notnull_strength="1" exp_strength="0"/>
    <constraint unique_strength="0" field="encoberto" constraints="1" notnull_strength="1" exp_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint desc="" exp="" field="tipotrechodrenagem"/>
    <constraint desc="" exp="" field="navegavel"/>
    <constraint desc="" exp="" field="larguramedia"/>
    <constraint desc="" exp="" field="regime"/>
    <constraint desc="" exp="" field="encoberto"/>

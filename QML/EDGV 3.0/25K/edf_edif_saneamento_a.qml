...
<qgis version="3.4.14-Madeira" minScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" simplifyLocal="1" simplifyDrawingHints="1" readOnly="0" styleCategories="AllStyleCategories" labelsEnabled="0" maxScale="0" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0">
  ...
  <fieldConfiguration>
    ...
    <field name="tipoedifsaneam">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              <Option type="QString" value="8" name="Administração"/>
              <Option type="QString" value="95" name="Desconhecido"/>
              <Option type="QString" value="7" name="Incinerador"/>
              <Option type="QString" value="99" name="Outros"/>
              <Option type="QString" value="3" name="Recalque"/>
              <Option type="QString" value="5" name="Tratamento de esgoto"/>
              <Option type="QString" value="6" name="Usina de reciclagem"/>
            </Option>
          </Option>
        </config>
      </editWidget>
  ...
  <aliases>
    ...
    <alias index="28" field="tipoedifsaneam" name=""/>
    <alias index="29" field="id_complexo_saneamento" name=""/>
    <alias index="30" field="area_otf" name=""/>
  </aliases>
  ...
  <defaults>
    ...
    <default applyOnUpdate="0" field="tipoedifsaneam" expression=""/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" field="tipoedifsaneam" constraints="1" notnull_strength="1" exp_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint desc="" exp="" field="tipoedifsaneam"/>

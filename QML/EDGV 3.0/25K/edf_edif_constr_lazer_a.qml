...
<qgis version="3.4.14-Madeira" minScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" simplifyLocal="1" simplifyDrawingHints="1" readOnly="0" styleCategories="AllStyleCategories" labelsEnabled="0" maxScale="0" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0">
  ...
  <fieldConfiguration>
    ...
    <field name="tipoediflazer">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              <Option type="QString" value="22" name="Administração"/>
              <Option type="QString" value="5" name="Anfiteatro"/>
              <Option type="QString" value="9" name="Arquivo"/>
              <Option type="QString" value="10" name="Biblioteca"/>
              <Option type="QString" value="7" name="Centro cultural"/>
              <Option type="QString" value="11" name="Centro de documentação"/>
              <Option type="QString" value="12" name="Circo"/>
              <Option type="QString" value="13" name="Concha acústica"/>
              <Option type="QString" value="14" name="Conservatório"/>
              <Option type="QString" value="15" name="Coreto ou tribuna"/>
              <Option type="QString" value="95" name="Desconhecido"/>
              <Option type="QString" value="17" name="Equipamentos culturais diversos"/>
              <Option type="QString" value="18" name="Espaço de eventos e/ ou cultural"/>
              <Option type="QString" value="6" name="Espaço de exibição de filmes"/>
              <Option type="QString" value="1" name="Estádio"/>
              <Option type="QString" value="19" name="Galeria"/>
              <Option type="QString" value="2" name="Ginásio"/>
              <Option type="QString" value="3" name="Museu"/>
              <Option type="QString" value="99" name="Outros"/>
              <Option type="QString" value="8" name="Plataforma de pesca"/>
              <Option type="QString" value="21" name="Quiosque"/>
              <Option type="QString" value="4" name="Teatro"/>
            </Option>
          </Option>
        </config>
      </editWidget>
    </field>
    <field name="id_complexo_desportivo_lazer">
      <editWidget type="">
        <config>
          <Option/>
        </config>
    ...
    <field name="id_complexo_desportivo">
      <editWidget type="">
        <config>
          <Option/>
        </config>
    ...
    <field name="id_complexo_recreativo">
      <editWidget type="">
        <config>
          <Option/>
        </config>
  ...
  <aliases>
    ...
    <alias index="28" field="tipoediflazer" name=""/>
    <alias index="29" field="id_complexo_desportivo_lazer" name=""/>
    <alias index="30" field="id_complexo_desportivo" name=""/>
    <alias index="31" field="id_complexo_recreativo" name=""/>
  ...
  <defaults>
    ...
    <default applyOnUpdate="0" field="tipoediflazer" expression=""/>
    <default applyOnUpdate="0" field="id_complexo_desportivo_lazer" expression=""/>
    <default applyOnUpdate="0" field="id_complexo_desportivo" expression=""/>
    <default applyOnUpdate="0" field="id_complexo_recreativo" expression=""/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" field="tipoediflazer" constraints="1" notnull_strength="1" exp_strength="0"/>
    <constraint unique_strength="0" field="id_complexo_desportivo_lazer" constraints="0" notnull_strength="0" exp_strength="0"/>
    <constraint unique_strength="0" field="id_complexo_desportivo" constraints="0" notnull_strength="0" exp_strength="0"/>
    <constraint unique_strength="0" field="id_complexo_recreativo" constraints="0" notnull_strength="0" exp_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint desc="" exp="" field="tipoediflazer"/>
    <constraint desc="" exp="" field="id_complexo_desportivo_lazer"/>
    <constraint desc="" exp="" field="id_complexo_desportivo"/>
    <constraint desc="" exp="" field="id_complexo_recreativo"/>

    ...
    <field name="tipounidprotegida">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              <Option type="QString" value="5" name="Outras unidades protegidas"/>
              <Option type="QString" value="4" name="Unidade de conservação"/>
              <Option type="QString" value="1" name="Unidade de conservação não SNUC"/>

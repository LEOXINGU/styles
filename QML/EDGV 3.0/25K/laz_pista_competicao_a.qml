...
<qgis version="3.4.14-Madeira" minScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" simplifyLocal="1" simplifyDrawingHints="1" readOnly="0" styleCategories="AllStyleCategories" labelsEnabled="0" maxScale="0" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0">
  ...
  <fieldConfiguration>
    ...
    <field name="tipopistacomp">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              <Option type="QString" value="1" name="Atletismo"/>
              <Option type="QString" value="4" name="Automobilismo"/>
              <Option type="QString" value="6" name="Bicicross"/>
              <Option type="QString" value="7" name="Ciclismo"/>
              <Option type="QString" value="5" name="Corrida de cavalos"/>
              <Option type="QString" value="95" name="Desconhecido"/>
              <Option type="QString" value="98" name="Misto"/>
              <Option type="QString" value="3" name="Motociclismo"/>
              <Option type="QString" value="8" name="Motocross"/>
  ...
  <aliases>
    ...
    <alias index="5" field="tipopistacomp" name=""/>
    <alias index="6" field="id_complexo_desportivo_lazer" name=""/>
    <alias index="7" field="id_complexo_desportivo" name=""/>
    <alias index="8" field="id_complexo_recreativo" name=""/>
  ...
  <defaults>
    ...
    <default applyOnUpdate="0" field="tipopistacomp" expression=""/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" field="tipopistacomp" constraints="1" notnull_strength="1" exp_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint desc="" exp="" field="tipopistacomp"/>

...
<qgis version="3.4.14-Madeira" minScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" simplifyLocal="1" simplifyDrawingHints="1" readOnly="0" styleCategories="AllStyleCategories" labelsEnabled="0" maxScale="0" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0">
  ...
  <fieldConfiguration>
    ...
    <field name="tipocampoquadra">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              <Option type="QString" value="2" name="Basquetebol"/>
              <Option type="QString" value="95" name="Desconhecido"/>
              <Option type="QString" value="1" name="Futebol"/>
              <Option type="QString" value="5" name="Hipismo"/>
              <Option type="QString" value="99" name="Outros"/>
              <Option type="QString" value="6" name="Poliesportiva"/>
              <Option type="QString" value="4" name="Pólo"/>
              <Option type="QString" value="7" name="Tênis"/>
              <Option type="QString" value="3" name="Voleibol"/>
            </Option>
          </Option>
        </config>
      </editWidget>
  ...
  <aliases>
    ...
    <alias index="5" field="tipocampoquadra" name=""/>
  ...
  <defaults>
    ...
    <default applyOnUpdate="0" field="tipocampoquadra" expression=""/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" field="tipocampoquadra" constraints="1" notnull_strength="1" exp_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint desc="" exp="" field="tipocampoquadra"/>

...
<qgis version="3.4.14-Madeira" minScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" simplifyLocal="1" simplifyDrawingHints="1" readOnly="0" styleCategories="AllStyleCategories" labelsEnabled="0" maxScale="0" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0">
  ...
  <aliases>
    ...
    <alias index="28" field="coletiva" name=""/>
    <alias index="29" field="isolada" name=""/>
    <alias index="30" field="id_aldeia_indigena" name=""/>
  ...
  <defaults>
    ...
    <default applyOnUpdate="0" field="coletiva" expression=""/>
    <default applyOnUpdate="0" field="isolada" expression=""/>
    <default applyOnUpdate="0" field="id_aldeia_indigena" expression=""/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" field="coletiva" constraints="1" notnull_strength="1" exp_strength="0"/>
    <constraint unique_strength="0" field="isolada" constraints="1" notnull_strength="1" exp_strength="0"/>
    <constraint unique_strength="0" field="id_aldeia_indigena" constraints="0" notnull_strength="0" exp_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint desc="" exp="" field="coletiva"/>
    <constraint desc="" exp="" field="isolada"/>
    <constraint desc="" exp="" field="id_aldeia_indigena"/>

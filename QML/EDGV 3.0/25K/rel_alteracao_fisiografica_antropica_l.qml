    ...
    <field name="tipoalterantrop">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              <Option type="QString" value="27" name="Aterro"/>
              <Option type="QString" value="24" name="Caixa de empréstimo"/>
              <Option type="QString" value="30" name="Canal"/>
              <Option type="QString" value="26" name="Corte"/>
              <Option type="QString" value="95" name="Desconhecido"/>
              <Option type="QString" value="99" name="Outros"/>
              <Option type="QString" value="28" name="Resíduo de bota-fora"/>
              <Option type="QString" value="29" name="Resíduo sólido em geral"/>
              <Option type="QString" value="31" name="Vala"/>

...
<qgis version="3.4.14-Madeira" minScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" simplifyLocal="1" simplifyDrawingHints="1" readOnly="0" styleCategories="AllStyleCategories" labelsEnabled="0" maxScale="0" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0">
    ...
    <field name="tipoestgerad">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              <Option type="QString" value="8" name="Hidrelétrica"/>
            </Option>
          </Option>
        </config>
      </editWidget>
    ...
    <field name="tipoahe">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              <Option type="QString" value="3" name="CGH"/>
              <Option type="QString" value="2" name="PCH"/>
              <Option type="QString" value="1" name="UHE"/>
            </Option>
          </Option>
        </config>
      </editWidget>
  ...
  <aliases>
    ...
    <alias index="3" field="ceg" name=""/>
    <alias index="4" field="tipoestgerad" name=""/>
    <alias index="5" field="operacional" name=""/>
    <alias index="6" field="situacaofisica" name=""/>
    <alias index="7" field="potenciaout" name=""/>
    <alias index="8" field="id_complexo_gerador_energia_eletrica" name=""/>
    <alias index="9" field="tipoahe" name=""/>
    <alias index="10" field="lenght_otf" name=""/>
  </aliases>
  ...
  <defaults>
    ...
    <default applyOnUpdate="0" field="ceg" expression=""/>
    ...
    <default applyOnUpdate="0" field="potenciaout" expression=""/>
    <default applyOnUpdate="0" field="id_complexo_gerador_energia_eletrica" expression=""/>
    <default applyOnUpdate="0" field="tipoahe" expression=""/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" field="ceg" constraints="0" notnull_strength="0" exp_strength="0"/>
    <constraint unique_strength="0" field="tipoestgerad" constraints="1" notnull_strength="1" exp_strength="0"/>
    ...
    <constraint unique_strength="0" field="potenciaout" constraints="0" notnull_strength="0" exp_strength="0"/>
    <constraint unique_strength="0" field="id_complexo_gerador_energia_eletrica" constraints="0" notnull_strength="0" exp_strength="0"/>
    <constraint unique_strength="0" field="tipoahe" constraints="1" notnull_strength="1" exp_strength="0"/>

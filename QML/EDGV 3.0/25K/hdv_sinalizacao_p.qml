...
<qgis version="3.4.14-Madeira" minScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" simplifyLocal="1" simplifyDrawingHints="1" readOnly="0" styleCategories="AllStyleCategories" labelsEnabled="0" maxScale="0" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0">
  ...
  <fieldConfiguration>
    ...
    <field name="tiposinal">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              <Option type="QString" value="5" name="Barca farol"/>
              <Option type="QString" value="2" name="Bóia cega"/>
              <Option type="QString" value="3" name="Bóia de amarração"/>
              <Option type="QString" value="1" name="Bóia luminosa"/>
              <Option type="QString" value="95" name="Desconhecido"/>
              <Option type="QString" value="4" name="Farol ou farolete"/>
              <Option type="QString" value="6" name="Sinalização de margem"/>
            </Option>
          </Option>
        </config>
      </editWidget>
  ...
  <aliases>
    ...
    <alias index="3" field="tiposinal" name=""/>
  ...
  <defaults>
    ...
    <default applyOnUpdate="0" field="tiposinal" expression=""/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" field="tiposinal" constraints="1" notnull_strength="1" exp_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint desc="" exp="" field="tiposinal"/>

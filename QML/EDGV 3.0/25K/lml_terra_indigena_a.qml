...
<qgis version="3.4.14-Madeira" minScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" simplifyLocal="1" simplifyDrawingHints="1" readOnly="0" styleCategories="AllStyleCategories" labelsEnabled="0" maxScale="0" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0">
    ...
    <field name="situacaojuridica">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              <Option type="QString" value="2" name="Declarada"/>
              <Option type="QString" value="1" name="Delimitada"/>
              <Option type="QString" value="3" name="Homologada ou demarcada"/>
              <Option type="QString" value="4" name="Regularizada"/>
            </Option>
          </Option>
        </config>
      </editWidget>
  ...
  <aliases>
    ...
    <alias index="5" field="classificacao" name=""/>
    <alias index="6" field="administracao" name=""/>
    <alias index="7" field="jurisdicao" name=""/>
    <alias index="8" field="situacaojuridica" name=""/>
    <alias index="9" field="datasituacaojuridica" name=""/>
    <alias index="10" field="grupoetnico" name=""/>
    <alias index="11" field="perimetrooficial" name=""/>
    <alias index="12" field="area_otf" name=""/>
  </aliases>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" field="situacaojuridica" constraints="1" notnull_strength="1" exp_strength="0"/>
    <constraint unique_strength="0" field="datasituacaojuridica" constraints="0" notnull_strength="0" exp_strength="0"/>
    <constraint unique_strength="0" field="grupoetnico" constraints="0" notnull_strength="0" exp_strength="0"/>
    <constraint unique_strength="0" field="perimetrooficial" constraints="0" notnull_strength="0" exp_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint desc="" exp="" field="situacaojuridica"/>
    <constraint desc="" exp="" field="datasituacaojuridica"/>
    <constraint desc="" exp="" field="grupoetnico"/>
    <constraint desc="" exp="" field="perimetrooficial"/>

...
<qgis version="3.4.14-Madeira" minScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" simplifyLocal="1" simplifyDrawingHints="1" readOnly="0" styleCategories="AllStyleCategories" labelsEnabled="0" maxScale="0" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0">
        ...
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              ...
              <Option type="QString" value="18" name="Argila"/>
              <Option type="QString" value="17" name="Concha"/>
              <Option type="QString" value="20" name="Coral"/>
              <Option type="QString" value="95" name="Desconhecido"/>
              <Option type="QString" value="22" name="Ervas marinhas"/>
              <Option type="QString" value="14" name="Lama"/>
              <Option type="QString" value="19" name="Lodo"/>
              ...
              <Option type="QString" value="21" name="Seixo"/>
            </Option>
          </Option>
        </config>
      </editWidget>
  ...
  <aliases>
    ...
    <alias index="3" field="tipobanco" name=""/>
    <alias index="4" field="situacaoemagua" name=""/>
    <alias index="5" field="materialpredominante" name=""/>
  ...
  <defaults>
    ...
    <default applyOnUpdate="0" field="tipobanco" expression=""/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" field="tipobanco" constraints="1" notnull_strength="1" exp_strength="0"/>
    <constraint unique_strength="0" field="situacaoemagua" constraints="0" notnull_strength="0" exp_strength="0"/>
    <constraint unique_strength="0" field="materialpredominante" constraints="0" notnull_strength="0" exp_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint desc="" exp="" field="tipobanco"/>
    <constraint desc="" exp="" field="situacaoemagua"/>
    <constraint desc="" exp="" field="materialpredominante"/>

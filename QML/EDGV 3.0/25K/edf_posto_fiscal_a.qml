...
<qgis version="3.4.14-Madeira" minScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" simplifyLocal="1" simplifyDrawingHints="1" readOnly="0" styleCategories="AllStyleCategories" labelsEnabled="0" maxScale="0" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0">
  ...
  <fieldConfiguration>
    ...
    <field name="tipoedifpubcivil">
      <editWidget type="ValueRelation">
        <config>
          <Option type="Map">
            <Option type="bool" value="true" name="AllowMulti"/>
            <Option type="bool" value="true" name="AllowNull"/>
            <Option type="QString" value="code in (1,10,11,12,13,14,15,16,2,22,3,4,5,6,7,8,9,95,99)" name="FilterExpression"/>
            <Option type="QString" value="code" name="Key"/>
            <Option type="QString" value="tipo_org_civil_c50b02eb_0c53_4a26_82b2_7e1c0ed67bc4" name="Layer"/>
            <Option type="QString" value="code_name" name="Value"/>
          </Option>
        </config>
      </editWidget>
    </field>
    <field name="tipopostofisc">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              <Option type="QString" value="95" name="Desconhecido"/>
              <Option type="QString" value="12" name="Fiscalização sanitária"/>
              <Option type="QString" value="98" name="Misto"/>
              <Option type="QString" value="99" name="Outros"/>
              <Option type="QString" value="13" name="Posto de pesagem"/>
              <Option type="QString" value="10" name="Tributação"/>
            </Option>
          </Option>
        </config>
      </editWidget>
  ...
  <aliases>
    ...
    <alias index="30" field="tipoedifpubcivil" name=""/>
    <alias index="31" field="tipopostofisc" name=""/>
    <alias index="32" field="concessionaria" name=""/>
    <alias index="33" field="area_otf" name=""/>
  </aliases>
  ...
  <defaults>
    ...
    <default applyOnUpdate="0" field="tipoedifpubcivil" expression=""/>
    <default applyOnUpdate="0" field="tipopostofisc" expression=""/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" field="tipoedifpubcivil" constraints="0" notnull_strength="0" exp_strength="0"/>
    <constraint unique_strength="0" field="tipopostofisc" constraints="1" notnull_strength="1" exp_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint desc="" exp="" field="tipoedifpubcivil"/>
    <constraint desc="" exp="" field="tipopostofisc"/>

...
<qgis version="3.4.14-Madeira" minScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" simplifyLocal="1" simplifyDrawingHints="1" readOnly="0" styleCategories="AllStyleCategories" labelsEnabled="0" maxScale="0" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0">
  ...
  <fieldConfiguration>
        ...
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              ...
              <Option type="QString" value="2" name="Distribuição"/>
              <Option type="QString" value="3" name="Transmissão"/>
            </Option>
          </Option>
        </config>
      </editWidget>
    ...
    <field name="largurafaixaservidao">
      <editWidget type="">
        <config>
          <Option/>
        </config>
  ...
  <defaults>
    ...
    <default applyOnUpdate="0" field="largurafaixaservidao" expression=""/>
    <default applyOnUpdate="0" field="sin" expression=""/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" field="especie" constraints="0" notnull_strength="0" exp_strength="0"/>
    ...
    <constraint unique_strength="0" field="largurafaixaservidao" constraints="0" notnull_strength="0" exp_strength="0"/>
    <constraint unique_strength="0" field="sin" constraints="0" notnull_strength="0" exp_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint desc="" exp="" field="largurafaixaservidao"/>
    <constraint desc="" exp="" field="sin"/>

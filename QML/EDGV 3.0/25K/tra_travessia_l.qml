...
<qgis version="3.4.14-Madeira" minScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" simplifyLocal="1" simplifyDrawingHints="1" readOnly="0" styleCategories="AllStyleCategories" labelsEnabled="0" maxScale="0" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0">
  ...
  <fieldConfiguration>
    ...
    <field name="tipotravessia">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              <Option type="QString" value="4" name="Balsa"/>
              <Option type="QString" value="3" name="Bote transportador"/>
              <Option type="QString" value="95" name="Desconhecido"/>
              <Option type="QString" value="2" name="Vau construída"/>
              <Option type="QString" value="1" name="Vau natural"/>
            </Option>
          </Option>
        </config>
      </editWidget>
    ...
    <field name="tipouso">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              <Option type="QString" value="22" name="Carga"/>
              <Option type="QString" value="95" name="Desconhecido"/>
              <Option type="QString" value="98" name="Misto"/>
              <Option type="QString" value="21" name="Passageiro"/>
            </Option>
          </Option>
        </config>
      </editWidget>
    </field>
    <field name="tipoembarcacao">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              <Option type="QString" value="2" name="Balsa"/>
              <Option type="QString" value="95" name="Desconhecido"/>
              <Option type="QString" value="7" name="Embarcação de pequeno porte"/>
              <Option type="QString" value="6" name="Empurrador-balsa"/>
              <Option type="QString" value="3" name="Lancha"/>
  ...
  <aliases>
    ...
    <alias index="3" field="tipotravessia" name=""/>
    <alias index="4" field="tipouso" name=""/>
    <alias index="5" field="tipoembarcacao" name=""/>
  ...
  <defaults>
    ...
    <default applyOnUpdate="0" field="tipotravessia" expression=""/>
    <default applyOnUpdate="0" field="tipouso" expression=""/>
    <default applyOnUpdate="0" field="tipoembarcacao" expression=""/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" field="tipotravessia" constraints="1" notnull_strength="1" exp_strength="0"/>
    <constraint unique_strength="0" field="tipouso" constraints="1" notnull_strength="1" exp_strength="0"/>
    <constraint unique_strength="0" field="tipoembarcacao" constraints="1" notnull_strength="1" exp_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint desc="" exp="" field="tipotravessia"/>
    <constraint desc="" exp="" field="tipouso"/>
    <constraint desc="" exp="" field="tipoembarcacao"/>

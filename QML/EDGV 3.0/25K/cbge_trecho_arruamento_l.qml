...
<qgis version="3.4.14-Madeira" minScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" simplifyLocal="1" simplifyDrawingHints="1" readOnly="0" styleCategories="AllStyleCategories" labelsEnabled="0" maxScale="0" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0">
  ...
  <aliases>
    ...
    <alias index="14" field="meiofio" name=""/>
    <alias index="15" field="sargeta" name=""/>
  ...
  <defaults>
    ...
    <default applyOnUpdate="0" field="meiofio" expression=""/>
    <default applyOnUpdate="0" field="sargeta" expression=""/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" field="meiofio" constraints="1" notnull_strength="1" exp_strength="0"/>
    <constraint unique_strength="0" field="sargeta" constraints="1" notnull_strength="1" exp_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint desc="" exp="" field="meiofio"/>
    <constraint desc="" exp="" field="sargeta"/>

...
<qgis version="3.4.14-Madeira" minScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" simplifyLocal="1" simplifyDrawingHints="1" readOnly="0" styleCategories="AllStyleCategories" labelsEnabled="0" maxScale="0" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0">
  ...
  <aliases>
    ...
    <alias index="2" field="operacional" name=""/>
    <alias index="3" field="situacaofisica" name=""/>
    <alias index="4" field="regime" name=""/>
    <alias index="5" field="extensaotrecho" name=""/>
    <alias index="6" field="caladomaxseca" name=""/>
  ...
  <defaults>
    ...
    <default applyOnUpdate="0" field="extensaotrecho" expression=""/>
    <default applyOnUpdate="0" field="caladomaxseca" expression=""/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" field="extensaotrecho" constraints="0" notnull_strength="0" exp_strength="0"/>
    <constraint unique_strength="0" field="caladomaxseca" constraints="0" notnull_strength="0" exp_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint desc="" exp="" field="extensaotrecho"/>
    <constraint desc="" exp="" field="caladomaxseca"/>

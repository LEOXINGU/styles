...
<qgis version="3.4.14-Madeira" minScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" simplifyLocal="1" simplifyDrawingHints="1" readOnly="0" styleCategories="AllStyleCategories" labelsEnabled="0" maxScale="0" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0">
  ...
  <fieldConfiguration>
        ...
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              ...
              <Option type="QString" value="4" name="Pedregoso"/>
    ...
    <field name="causaexposicao">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              <Option type="QString" value="3" name="Artificial"/>
              <Option type="QString" value="95" name="Desconhecida"/>
              <Option type="QString" value="2" name="Natural"/>
            </Option>
          </Option>
        </config>
      </editWidget>
  ...
  <aliases>
    ...
    <alias index="2" field="tipoterrexp" name=""/>
    <alias index="3" field="causaexposicao" name=""/>
  ...
  <defaults>
    ...
    <default applyOnUpdate="0" field="tipoterrexp" expression=""/>
    <default applyOnUpdate="0" field="causaexposicao" expression=""/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" field="tipoterrexp" constraints="0" notnull_strength="0" exp_strength="0"/>
    <constraint unique_strength="0" field="causaexposicao" constraints="0" notnull_strength="0" exp_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint desc="" exp="" field="tipoterrexp"/>
    <constraint desc="" exp="" field="causaexposicao"/>

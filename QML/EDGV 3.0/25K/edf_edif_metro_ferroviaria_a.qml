...
<qgis version="3.4.14-Madeira" minScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" simplifyLocal="1" simplifyDrawingHints="1" readOnly="0" styleCategories="AllStyleCategories" labelsEnabled="0" maxScale="0" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0">
  ...
  <fieldConfiguration>
    ...
    <field name="tipoedifmetroferrov">
      <editWidget type="ValueRelation">
        <config>
          <Option type="Map">
            <Option type="bool" value="true" name="AllowMulti"/>
            <Option type="bool" value="true" name="AllowNull"/>
            <Option type="QString" value="code in (15,16,17,18,19,20,95,99)" name="FilterExpression"/>
            <Option type="QString" value="code" name="Key"/>
            <Option type="QString" value="tipo_edif_metro_ferrov_4f213ba8_8ed4_412f_bf2c_48ae3106292e" name="Layer"/>
            <Option type="QString" value="code_name" name="Value"/>
          </Option>
        </config>
      </editWidget>
  ...
  <aliases>
    ...
    <alias index="28" field="tipoedifmetroferrov" name=""/>
    <alias index="29" field="jurisdicao" name=""/>
    <alias index="30" field="concessionaria" name=""/>
    <alias index="31" field="id_estrut_apoio" name=""/>
    <alias index="32" field="id_estacao_ferroviaria" name=""/>
  ...
  <defaults>
    ...
    <default applyOnUpdate="0" field="tipoedifmetroferrov" expression=""/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" field="tipoedifmetroferrov" constraints="1" notnull_strength="1" exp_strength="0"/>
    <constraint unique_strength="0" field="jurisdicao" constraints="0" notnull_strength="0" exp_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint desc="" exp="" field="tipoedifmetroferrov"/>

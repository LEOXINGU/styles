...
<qgis version="3.4.14-Madeira" minScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" simplifyLocal="1" simplifyDrawingHints="1" readOnly="0" styleCategories="AllStyleCategories" labelsEnabled="0" maxScale="0" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0">
        ...
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              ...
              <Option type="QString" value="3" name="Sinal de TV"/>
              <Option type="QString" value="7" name="Telefônica"/>
            </Option>
          </Option>
        </config>
      </editWidget>
  ...
  <defaults>
    ...
    <default applyOnUpdate="0" field="matcondutor" expression=""/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" field="tipotrechocomunic" constraints="1" notnull_strength="1" exp_strength="0"/>
    <constraint unique_strength="0" field="posicaorelativa" constraints="1" notnull_strength="1" exp_strength="0"/>
    <constraint unique_strength="0" field="matcondutor" constraints="0" notnull_strength="0" exp_strength="0"/>
    ...
    <constraint unique_strength="0" field="emduto" constraints="0" notnull_strength="0" exp_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint desc="" exp="" field="tipotrechocomunic"/>
    <constraint desc="" exp="" field="posicaorelativa"/>
    <constraint desc="" exp="" field="matcondutor"/>

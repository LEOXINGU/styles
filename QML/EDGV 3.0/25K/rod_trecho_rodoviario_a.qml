...
<qgis version="3.4.14-Madeira" minScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" simplifyLocal="1" simplifyDrawingHints="1" readOnly="0" styleCategories="AllStyleCategories" labelsEnabled="0" maxScale="0" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0">
  ...
  <aliases>
    ...
    <alias index="14" field="sigla" name=""/>
    <alias index="15" field="codtrechorod" name=""/>
    <alias index="16" field="limitevelocidade" name=""/>
    <alias index="17" field="emperimetrourbano" name=""/>
    <alias index="18" field="acostamento" name=""/>
    <alias index="19" field="area_otf" name=""/>
  </aliases>
  ...
  <defaults>
    ...
    <default applyOnUpdate="0" field="codtrechorod" expression=""/>
    <default applyOnUpdate="0" field="limitevelocidade" expression=""/>
    <default applyOnUpdate="0" field="emperimetrourbano" expression=""/>
    <default applyOnUpdate="0" field="acostamento" expression=""/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" field="codtrechorod" constraints="0" notnull_strength="0" exp_strength="0"/>
    <constraint unique_strength="0" field="limitevelocidade" constraints="0" notnull_strength="0" exp_strength="0"/>
    <constraint unique_strength="0" field="emperimetrourbano" constraints="0" notnull_strength="0" exp_strength="0"/>
    <constraint unique_strength="0" field="acostamento" constraints="0" notnull_strength="0" exp_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint desc="" exp="" field="codtrechorod"/>
    <constraint desc="" exp="" field="limitevelocidade"/>
    <constraint desc="" exp="" field="emperimetrourbano"/>
    <constraint desc="" exp="" field="acostamento"/>

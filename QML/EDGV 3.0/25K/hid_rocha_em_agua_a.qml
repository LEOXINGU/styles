...
<qgis version="3.4.14-Madeira" minScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" simplifyLocal="1" simplifyDrawingHints="1" readOnly="0" styleCategories="AllStyleCategories" labelsEnabled="0" maxScale="0" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0">
  ...
  <fieldConfiguration>
    ...
    <field name="formarocha">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              <Option type="QString" value="95" name="Desconhecida"/>
              <Option type="QString" value="21" name="Matacão - pedra"/>
              <Option type="QString" value="22" name="Penedo isolado"/>
              <Option type="QString" value="23" name="Área rochosa - lajedo"/>
            </Option>
          </Option>
        </config>
      </editWidget>
  ...
  <aliases>
    ...
    <alias index="4" field="formarocha" name=""/>
    <alias index="5" field="situacaoemagua" name=""/>
    <alias index="6" field="alturalamina" name=""/>
  ...
  <defaults>
    ...
    <default applyOnUpdate="0" field="formarocha" expression=""/>
    <default applyOnUpdate="0" field="situacaoemagua" expression=""/>
    <default applyOnUpdate="0" field="alturalamina" expression=""/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" field="formarocha" constraints="0" notnull_strength="0" exp_strength="0"/>
    <constraint unique_strength="0" field="situacaoemagua" constraints="1" notnull_strength="1" exp_strength="0"/>
    <constraint unique_strength="0" field="alturalamina" constraints="0" notnull_strength="0" exp_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint desc="" exp="" field="formarocha"/>
    <constraint desc="" exp="" field="situacaoemagua"/>
    <constraint desc="" exp="" field="alturalamina"/>

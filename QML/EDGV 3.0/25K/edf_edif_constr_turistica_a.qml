...
<qgis version="3.4.14-Madeira" minScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" simplifyLocal="1" simplifyDrawingHints="1" readOnly="0" styleCategories="AllStyleCategories" labelsEnabled="0" maxScale="0" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0">
  ...
  <fieldConfiguration>
    ...
    <field name="tipoedifturist">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              <Option type="QString" value="19" name="Administração"/>
              <Option type="QString" value="14" name="Chafariz"/>
              <Option type="QString" value="15" name="Chaminé"/>
              <Option type="QString" value="9" name="Cruzeiro"/>
              <Option type="QString" value="95" name="Desconhecido"/>
              <Option type="QString" value="16" name="Escultura"/>
              <Option type="QString" value="10" name="Estátua"/>
              <Option type="QString" value="11" name="Mirante"/>
              <Option type="QString" value="12" name="Monumento"/>
              <Option type="QString" value="17" name="Obelisco"/>
              <Option type="QString" value="99" name="Outros"/>
              <Option type="QString" value="13" name="Panteão"/>
              <Option type="QString" value="18" name="Torre"/>
            </Option>
          </Option>
        </config>
      </editWidget>
  ...
  <aliases>
    ...
    <alias index="28" field="tipoedifturist" name=""/>
    <alias index="29" field="ovgd" name=""/>
    <alias index="30" field="tombada" name=""/>
    <alias index="31" field="id_complexo_desportivo_lazer" name=""/>
    <alias index="32" field="id_complexo_desportivo" name=""/>
    <alias index="33" field="id_complexo_recreativo" name=""/>
    <alias index="34" field="area_otf" name=""/>
  </aliases>
  ...
  <defaults>
    ...
    <default applyOnUpdate="0" field="tipoedifturist" expression=""/>
    <default applyOnUpdate="0" field="ovgd" expression=""/>
    <default applyOnUpdate="0" field="tombada" expression=""/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" field="tipoedifturist" constraints="1" notnull_strength="1" exp_strength="0"/>
    <constraint unique_strength="0" field="ovgd" constraints="1" notnull_strength="1" exp_strength="0"/>
    <constraint unique_strength="0" field="tombada" constraints="0" notnull_strength="0" exp_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint desc="" exp="" field="tipoedifturist"/>
    <constraint desc="" exp="" field="ovgd"/>
    <constraint desc="" exp="" field="tombada"/>

...
<qgis version="3.4.14-Madeira" minScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" simplifyLocal="1" simplifyDrawingHints="1" readOnly="0" styleCategories="AllStyleCategories" labelsEnabled="0" maxScale="0" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0">
    ...
    <field name="tipoalterantrop">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              <Option type="QString" value="32" name="Área de extração mineral"/>
            </Option>
          </Option>
        </config>
      </editWidget>
    </field>
    <field name="secaoativecon">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              <Option type="QString" value="3" name="Construção"/>
              <Option type="QString" value="95" name="Desconhecido"/>
              <Option type="QString" value="2" name="Indústrias de transformação"/>
              <Option type="QString" value="1" name="Indústrias extrativas"/>
        ...
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              ...
              <Option type="QString" value="99" name="Outros"/>
              <Option type="QString" value="8" name="Poço de petróleo"/>
              <Option type="QString" value="1" name="Poço para água subterrânea"/>
    ...
    <field name="formaextracao">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              <Option type="QString" value="5" name="A céu aberto"/>
              <Option type="QString" value="95" name="Desconhecida"/>
  ...
  <aliases>
    ...
    <alias index="4" field="secaoativecon" name=""/>
    <alias index="5" field="operacional" name=""/>
    <alias index="6" field="situacaofisica" name=""/>
    <alias index="7" field="tipoextmin" name=""/>
    <alias index="8" field="tipoproduto" name=""/>
    <alias index="9" field="tipopocomina" name=""/>
    <alias index="10" field="procextracao" name=""/>
    <alias index="11" field="formaextracao" name=""/>
    <alias index="12" field="atividade" name=""/>
    <alias index="13" field="area_otf" name=""/>
  </aliases>
  ...
  <defaults>
    ...
    <default applyOnUpdate="0" field="secaoativecon" expression=""/>
    ...
    <default applyOnUpdate="0" field="tipoproduto" expression=""/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" field="secaoativecon" constraints="1" notnull_strength="1" exp_strength="0"/>
    ...
    <constraint unique_strength="0" field="tipoproduto" constraints="1" notnull_strength="1" exp_strength="0"/>
    <constraint unique_strength="0" field="tipopocomina" constraints="1" notnull_strength="1" exp_strength="0"/>
    <constraint unique_strength="0" field="procextracao" constraints="0" notnull_strength="0" exp_strength="0"/>

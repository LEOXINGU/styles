...
<qgis version="3.4.14-Madeira" minScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" simplifyLocal="1" simplifyDrawingHints="1" readOnly="0" styleCategories="AllStyleCategories" labelsEnabled="0" maxScale="0" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0">
  ...
  <fieldConfiguration>
    ...
    <field name="codequipdesenvsocial">
      <editWidget type="">
        <config>
          <Option/>
        </config>
    ...
    <field name="tipoequipdesenvsocial">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              <Option type="QString" value="1" name="Banco de Alimentos"/>
              <Option type="QString" value="2" name="Barragem Calçadão"/>
              <Option type="QString" value="3" name="Bolsa Verde"/>
              <Option type="QString" value="11" name="CRAS"/>
              <Option type="QString" value="12" name="CREAS"/>
              <Option type="QString" value="5" name="Centro POP"/>
              <Option type="QString" value="4" name="Centro de Convivência"/>
              <Option type="QString" value="6" name="Centro-dia"/>
              <Option type="QString" value="7" name="Cisterna Subterrânea"/>
              <Option type="QString" value="9" name="Cisterna de Placa"/>
              <Option type="QString" value="8" name="Cisterna de Polietileno"/>
              <Option type="QString" value="10" name="Cozinha Comunitária"/>
              <Option type="QString" value="95" name="Desconhecido"/>
              <Option type="QString" value="99" name="Outros"/>
              <Option type="QString" value="13" name="PAA"/>
              <Option type="QString" value="14" name="PRONAF"/>
              <Option type="QString" value="15" name="PRONATEC"/>
              <Option type="QString" value="16" name="Restaurante Popular"/>
              <Option type="QString" value="17" name="Unidade de acolhimento para crianças e adolescentes"/>
              <Option type="QString" value="18" name="Unidade de acolhimento para crianças e adolescentes (casa de passagem)"/>
              <Option type="QString" value="19" name="Unidade de acolhimento para idosos"/>
              <Option type="QString" value="20" name="Unidade de acolhimento para mulheres vitmas de violência"/>
              <Option type="QString" value="21" name="Unidade de acolhimento para pessoas em situação de rua"/>
            </Option>
          </Option>
        </config>
      </editWidget>
    </field>
    <field name="localizacaoequipdesenvsocial">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              <Option type="QString" value="95" name="Desconhecido"/>
              <Option type="QString" value="7" name="Outras Comunidades tradicionais"/>
              <Option type="QString" value="4" name="Rural"/>
              <Option type="QString" value="1" name="Terras Indígena"/>
              <Option type="QString" value="3" name="Terras Quilombola"/>
              <Option type="QString" value="2" name="Terras de População Ribeirinha"/>
              <Option type="QString" value="6" name="Urbana periférica"/>
              <Option type="QString" value="5" name="Urbano central"/>
            </Option>
          </Option>
        </config>
      </editWidget>
  ...
  <aliases>
    ...
    <alias index="28" field="sigla" name=""/>
    <alias index="29" field="codequipdesenvsocial" name=""/>
    <alias index="30" field="tipoequipdesenvsocial" name=""/>
    <alias index="31" field="localizacaoequipdesenvsocial" name=""/>
    <alias index="32" field="area_otf" name=""/>
  </aliases>
  ...
  <defaults>
    ...
    <default applyOnUpdate="0" field="codequipdesenvsocial" expression=""/>
    <default applyOnUpdate="0" field="tipoequipdesenvsocial" expression=""/>
    <default applyOnUpdate="0" field="localizacaoequipdesenvsocial" expression=""/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" field="codequipdesenvsocial" constraints="0" notnull_strength="0" exp_strength="0"/>
    <constraint unique_strength="0" field="tipoequipdesenvsocial" constraints="0" notnull_strength="0" exp_strength="0"/>
    <constraint unique_strength="0" field="localizacaoequipdesenvsocial" constraints="0" notnull_strength="0" exp_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint desc="" exp="" field="codequipdesenvsocial"/>
    <constraint desc="" exp="" field="tipoequipdesenvsocial"/>
    <constraint desc="" exp="" field="localizacaoequipdesenvsocial"/>

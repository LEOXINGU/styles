...
<qgis version="3.4.14-Madeira" minScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" simplifyLocal="1" simplifyDrawingHints="1" readOnly="0" styleCategories="AllStyleCategories" labelsEnabled="0" maxScale="0" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0">
      ...
      <editWidget type="ValueRelation">
        <config>
          <Option type="Map">
            ...
            <Option type="QString" value="code in (2,3,4,5,6,7,95,97,99)" name="FilterExpression"/>
            <Option type="QString" value="code" name="Key"/>
            <Option type="QString" value="tipo_pavimentacao_856d6bc5_1e29_4fee_9e3c_9794fd1792e6" name="Layer"/>
  ...
  <aliases>
    ...
    <alias index="2" field="largura" name=""/>
    <alias index="3" field="calcada" name=""/>
    <alias index="4" field="pavimentacao" name=""/>
  ...
  <defaults>
    ...
    <default applyOnUpdate="0" field="calcada" expression=""/>
    <default applyOnUpdate="0" field="pavimentacao" expression=""/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" field="calcada" constraints="1" notnull_strength="1" exp_strength="0"/>
    <constraint unique_strength="0" field="pavimentacao" constraints="1" notnull_strength="1" exp_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint desc="" exp="" field="calcada"/>
    <constraint desc="" exp="" field="pavimentacao"/>

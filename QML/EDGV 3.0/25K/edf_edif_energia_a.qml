...
<qgis version="3.4.14-Madeira" minScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" simplifyLocal="1" simplifyDrawingHints="1" readOnly="0" styleCategories="AllStyleCategories" labelsEnabled="0" maxScale="0" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0">
      ...
      <editWidget type="ValueRelation">
        <config>
          <Option type="Map">
            ...
            <Option type="QString" value="code" name="Key"/>
            <Option type="QString" value="tipo_edif_energia_9f826874_1976_4a29_825f_23510b4171b7" name="Layer"/>
            <Option type="QString" value="code_name" name="Value"/>
          </Option>
        </config>
      </editWidget>
  ...
  <aliases>
    ...
    <alias index="28" field="tipoedifenergia" name=""/>
    <alias index="29" field="id_complexo_gerador_energia_eletrica" name=""/>
    <alias index="30" field="id_subest_transm_distrib_energia_eletrica" name=""/>
    <alias index="31" field="area_otf" name=""/>
  </aliases>
  ...
  <defaults>
    ...
    <default applyOnUpdate="0" field="tipoedifenergia" expression=""/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" field="tipoedifenergia" constraints="1" notnull_strength="1" exp_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint desc="" exp="" field="tipoedifenergia"/>

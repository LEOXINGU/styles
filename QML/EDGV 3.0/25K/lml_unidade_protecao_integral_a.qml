...
<qgis version="3.4.14-Madeira" minScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" simplifyLocal="1" simplifyDrawingHints="1" readOnly="0" styleCategories="AllStyleCategories" labelsEnabled="0" maxScale="0" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0">
  ...
  <fieldConfiguration>
    ...
    <field name="codidentificadorunico">
      <editWidget type="">
        <config>
          <Option/>
        </config>
    ...
    <field name="historicomodificacoes">
      <editWidget type="">
        <config>
          <Option/>
        </config>
    ...
    <field name="tipounidprotegida">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              <Option type="QString" value="2" name="Unidade de proteção integral"/>
            </Option>
          </Option>
        </config>
      </editWidget>
    ...
    <field name="tipounidprotinteg">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              <Option type="QString" value="1" name="Estação ecológica - ESEC"/>
              <Option type="QString" value="3" name="Monumento natural – MONA"/>
              <Option type="QString" value="2" name="Parque PAR"/>
              <Option type="QString" value="5" name="Refúgio da vida silvestre – RVS"/>
              <Option type="QString" value="4" name="Reserva Biológica – REBIO"/>
            </Option>
          </Option>
        </config>
      </editWidget>
  ...
  <aliases>
    ...
    <alias index="3" field="codidentificadorunico" name=""/>
    <alias index="4" field="arealegal" name=""/>
    <alias index="5" field="anocriacao" name=""/>
    <alias index="6" field="historicomodificacoes" name=""/>
    <alias index="7" field="sigla" name=""/>
    <alias index="8" field="atolegal" name=""/>
    <alias index="9" field="areaoficial" name=""/>
    <alias index="10" field="administracao" name=""/>
    <alias index="11" field="classificacao" name=""/>
    <alias index="12" field="jurisdicao" name=""/>
    <alias index="13" field="tipounidprotegida" name=""/>
    <alias index="14" field="tipounidprotinteg" name=""/>
    <alias index="15" field="area_otf" name=""/>
  </aliases>
  ...
  <defaults>
    ...
    <default applyOnUpdate="0" field="codidentificadorunico" expression=""/>
    <default applyOnUpdate="0" field="arealegal" expression=""/>
    <default applyOnUpdate="0" field="anocriacao" expression=""/>
    <default applyOnUpdate="0" field="historicomodificacoes" expression=""/>
    ...
    <default applyOnUpdate="0" field="classificacao" expression=""/>
    <default applyOnUpdate="0" field="jurisdicao" expression=""/>
    <default applyOnUpdate="0" field="tipounidprotegida" expression=""/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" field="codidentificadorunico" constraints="0" notnull_strength="0" exp_strength="0"/>
    <constraint unique_strength="0" field="arealegal" constraints="0" notnull_strength="0" exp_strength="0"/>
    <constraint unique_strength="0" field="anocriacao" constraints="0" notnull_strength="0" exp_strength="0"/>
    <constraint unique_strength="0" field="historicomodificacoes" constraints="0" notnull_strength="0" exp_strength="0"/>
    <constraint unique_strength="0" field="sigla" constraints="0" notnull_strength="0" exp_strength="0"/>
    <constraint unique_strength="0" field="atolegal" constraints="0" notnull_strength="0" exp_strength="0"/>
    ...
    <constraint unique_strength="0" field="classificacao" constraints="0" notnull_strength="0" exp_strength="0"/>
    <constraint unique_strength="0" field="jurisdicao" constraints="1" notnull_strength="1" exp_strength="0"/>
    <constraint unique_strength="0" field="tipounidprotegida" constraints="1" notnull_strength="1" exp_strength="0"/>
    <constraint unique_strength="0" field="tipounidprotinteg" constraints="1" notnull_strength="1" exp_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint desc="" exp="" field="codidentificadorunico"/>
    <constraint desc="" exp="" field="arealegal"/>
    <constraint desc="" exp="" field="anocriacao"/>
    <constraint desc="" exp="" field="historicomodificacoes"/>
    <constraint desc="" exp="" field="sigla"/>
    <constraint desc="" exp="" field="atolegal"/>
    <constraint desc="" exp="" field="areaoficial"/>
    <constraint desc="" exp="" field="administracao"/>
    <constraint desc="" exp="" field="classificacao"/>
    <constraint desc="" exp="" field="jurisdicao"/>
    <constraint desc="" exp="" field="tipounidprotegida"/>
    <constraint desc="" exp="" field="tipounidprotinteg"/>

...
<qgis version="3.4.14-Madeira" minScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" simplifyLocal="1" simplifyDrawingHints="1" readOnly="0" styleCategories="AllStyleCategories" labelsEnabled="0" maxScale="0" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0">
  ...
  <fieldConfiguration>
    ...
    <field name="tipoequipagropec">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              <Option type="QString" value="95" name="Desconhecido"/>
              <Option type="QString" value="3" name="Elevador de grãos"/>
              <Option type="QString" value="4" name="Moega"/>
              <Option type="QString" value="2" name="Moinho"/>
              <Option type="QString" value="99" name="Outros"/>
              <Option type="QString" value="1" name="Pivô central"/>
              <Option type="QString" value="5" name="Secador"/>
              <Option type="QString" value="6" name="Tombador"/>
            </Option>
          </Option>
        </config>
      </editWidget>
  ...
  <aliases>
    ...
    <alias index="5" field="tipoequipagropec" name=""/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" field="tipoequipagropec" constraints="1" notnull_strength="1" exp_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint desc="" exp="" field="tipoequipagropec"/>

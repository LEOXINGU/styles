...
<qgis version="3.4.14-Madeira" minScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" simplifyLocal="1" simplifyDrawingHints="1" readOnly="0" styleCategories="AllStyleCategories" labelsEnabled="0" maxScale="0" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0">
      ...
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              <Option type="QString" value="95" name="Desconhecido"/>
              <Option type="QString" value="7" name="Estaiada"/>
  ...
  <aliases>
    ...
    <alias index="14" field="tipoponte" name=""/>
    <alias index="15" field="vaolivrehoriz" name=""/>
    <alias index="16" field="vaovertical" name=""/>
    <alias index="17" field="cargasuportmaxima" name=""/>
    <alias index="18" field="area_otf" name=""/>
  </aliases>
  ...
  <defaults>
    ...
    <default applyOnUpdate="0" field="tipoponte" expression=""/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" field="tipoponte" constraints="1" notnull_strength="1" exp_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint desc="" exp="" field="tipoponte"/>

...
<qgis version="3.4.14-Madeira" minScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" simplifyLocal="1" simplifyDrawingHints="1" readOnly="0" styleCategories="AllStyleCategories" labelsEnabled="0" maxScale="0" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0">
  ...
  <fieldConfiguration>
    ...
    <field name="tipomassadagua">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              <Option type="QString" value="4" name="Baía"/>
              <Option type="QString" value="95" name="Desconhecido"/>
              <Option type="QString" value="5" name="Enseada"/>
              <Option type="QString" value="7" name="Lago/Lagoa"/>
              <Option type="QString" value="9" name="Laguna"/>
              <Option type="QString" value="6" name="Meandro abandonado"/>
              <Option type="QString" value="3" name="Oceano"/>
    ...
    <field name="possuitrechodrenagem">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
  ...
  <aliases>
    ...
    <alias index="3" field="tipomassadagua" name=""/>
    <alias index="4" field="regime" name=""/>
    <alias index="5" field="salgada" name=""/>
    <alias index="6" field="dominialidade" name=""/>
    <alias index="7" field="artificial" name=""/>
    <alias index="8" field="possuitrechodrenagem" name=""/>
  ...
  <defaults>
    ...
    <default applyOnUpdate="0" field="salgada" expression=""/>
    <default applyOnUpdate="0" field="dominialidade" expression=""/>
    <default applyOnUpdate="0" field="artificial" expression=""/>
    <default applyOnUpdate="0" field="possuitrechodrenagem" expression=""/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" field="tipomassadagua" constraints="1" notnull_strength="1" exp_strength="0"/>
    <constraint unique_strength="0" field="regime" constraints="1" notnull_strength="1" exp_strength="0"/>
    <constraint unique_strength="0" field="salgada" constraints="1" notnull_strength="1" exp_strength="0"/>
    <constraint unique_strength="0" field="dominialidade" constraints="0" notnull_strength="0" exp_strength="0"/>
    <constraint unique_strength="0" field="artificial" constraints="1" notnull_strength="1" exp_strength="0"/>
    <constraint unique_strength="0" field="possuitrechodrenagem" constraints="1" notnull_strength="1" exp_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint desc="" exp="" field="salgada"/>
    <constraint desc="" exp="" field="dominialidade"/>
    <constraint desc="" exp="" field="artificial"/>
    <constraint desc="" exp="" field="possuitrechodrenagem"/>

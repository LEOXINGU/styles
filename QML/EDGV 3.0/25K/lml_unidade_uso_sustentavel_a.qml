...
<qgis version="3.4.14-Madeira" minScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" simplifyLocal="1" simplifyDrawingHints="1" readOnly="0" styleCategories="AllStyleCategories" labelsEnabled="0" maxScale="0" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0">
    ...
    <field name="tipounidprotegida">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              <Option type="QString" value="3" name="Unidade de uso sustentável"/>
            </Option>
          </Option>
        </config>
      </editWidget>
        ...
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              ...
              <Option type="QString" value="7" name="Reserva Particular de Patrimônio Natural – RPPN"/>
  ...
  <aliases>
    ...
    <alias index="14" field="tipounidusosust" name=""/>
  ...
  <defaults>
    ...
    <default applyOnUpdate="0" field="tipounidusosust" expression=""/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" field="tipounidusosust" constraints="1" notnull_strength="1" exp_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint desc="" exp="" field="tipounidusosust"/>

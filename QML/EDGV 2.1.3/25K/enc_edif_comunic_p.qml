...
<qgis version="3.4.14-Madeira" minScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" simplifyLocal="1" simplifyDrawingHints="1" readOnly="0" styleCategories="AllStyleCategories" labelsEnabled="0" maxScale="0" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0">
      ...
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              <Option type="QString" value="999" name="A SER PREENCHIDO"/>
              <Option type="QString" value="4" name="Dados"/>
              <Option type="QString" value="0" name="Desconhecido"/>
              <Option type="QString" value="99" name="Outras"/>
              <Option type="QString" value="1" name="Radiocomunicação"/>
              <Option type="QString" value="5" name="Radiodifusão/som"/>
              <Option type="QString" value="2" name="Radiodifusão/som e imagem"/>
              <Option type="QString" value="3" name="Telefonia"/>
            </Option>
          </Option>
        </config>
      </editWidget>
      ...
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              <Option type="QString" value="999" name="A SER PREENCHIDO"/>
              <Option type="QString" value="2" name="Central comutação e transmissão"/>
              <Option type="QString" value="1" name="Centro de operações"/>
              <Option type="QString" value="0" name="Desconhecido"/>
              <Option type="QString" value="3" name="Estação radio-base"/>
              <Option type="QString" value="4" name="Estação repetidora"/>
            </Option>
          </Option>
        </config>
      </editWidget>
  ...
  <aliases>
    ...
    <alias index="3" field="modalidade" name=""/>
    ...
    <alias index="8" field="tipoedifcomunic" name=""/>
  </aliases>

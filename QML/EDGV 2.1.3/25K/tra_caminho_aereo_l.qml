...
<qgis version="3.4.14-Madeira" minScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" simplifyLocal="1" simplifyDrawingHints="1" readOnly="0" styleCategories="AllStyleCategories" labelsEnabled="0" maxScale="0" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0">
        ...
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              ...
              <Option type="QString" value="12" name="Teleférico"/>
            </Option>
          </Option>
        </config>
      </editWidget>
    </field>
    <field name="tipousocaminhoaer">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              <Option type="QString" value="999" name="A SER PREENCHIDO"/>
              <Option type="QString" value="22" name="Cargas"/>
              <Option type="QString" value="0" name="Desconhecido"/>
              <Option type="QString" value="98" name="Misto"/>
              <Option type="QString" value="21" name="Passageiros"/>
            </Option>
          </Option>
        </config>
      </editWidget>
  ...
  <aliases>
    ...
    <alias index="6" field="tipocaminhoaereo" name=""/>
    <alias index="7" field="tipousocaminhoaer" name=""/>
  ...
  <defaults>
    ...
    <default applyOnUpdate="0" field="tipocaminhoaereo" expression=""/>
    <default applyOnUpdate="0" field="tipousocaminhoaer" expression=""/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" field="tipocaminhoaereo" constraints="1" notnull_strength="1" exp_strength="0"/>
    <constraint unique_strength="0" field="tipousocaminhoaer" constraints="1" notnull_strength="1" exp_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint desc="" exp="" field="tipocaminhoaereo"/>
    <constraint desc="" exp="" field="tipousocaminhoaer"/>

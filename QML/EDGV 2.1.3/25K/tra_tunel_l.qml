...
<qgis version="3.4.14-Madeira" minScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" simplifyLocal="1" simplifyDrawingHints="1" readOnly="0" styleCategories="AllStyleCategories" labelsEnabled="0" maxScale="0" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0">
  ...
  <fieldConfiguration>
      ...
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              <Option type="QString" value="999" name="A SER PREENCHIDO"/>
              <Option type="QString" value="7" name="Dutos"/>
    ...
    <field name="tipotunel">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              <Option type="QString" value="999" name="A SER PREENCHIDO"/>
              <Option type="QString" value="2" name="Passagem subterrânea sob via"/>
  ...
  <aliases>
    ...
    <alias index="1" field="altura" name=""/>
    <alias index="2" field="extensao" name=""/>
    <alias index="3" field="largura" name=""/>
    <alias index="4" field="geometriaaproximada" name=""/>
    <alias index="5" field="matconstr" name=""/>
    <alias index="6" field="modaluso" name=""/>
    <alias index="7" field="nome" name=""/>
    <alias index="8" field="nomeabrev" name=""/>
    <alias index="9" field="nrfaixas" name=""/>
    <alias index="10" field="nrpistas" name=""/>
    <alias index="11" field="operacional" name=""/>
    <alias index="12" field="posicaopista" name=""/>
    <alias index="13" field="situacaofisica" name=""/>
    <alias index="14" field="tipotunel" name=""/>
  ...
  <defaults>
    ...
    <default applyOnUpdate="0" field="altura" expression=""/>
    ...
    <default applyOnUpdate="0" field="tipotunel" expression=""/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" field="altura" constraints="0" notnull_strength="0" exp_strength="0"/>
    ...
    <constraint unique_strength="0" field="tipotunel" constraints="1" notnull_strength="1" exp_strength="0"/>

...
<qgis version="3.4.14-Madeira" minScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" simplifyLocal="1" simplifyDrawingHints="1" readOnly="0" styleCategories="AllStyleCategories" labelsEnabled="0" maxScale="0" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0">
  ...
  <fieldConfiguration>
    ...
    <field name="tipoaglomrurisol">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              <Option type="QString" value="999" name="A SER PREENCHIDO"/>
              <Option type="QString" value="6" name="Aglomerado Rural Isolado - Núcleo"/>
              <Option type="QString" value="5" name="Aglomerado Rural Isolado - Povoado"/>
              <Option type="QString" value="7" name="Outros Aglomerados Rurais Isolados"/>
            </Option>
          </Option>
        </config>
      </editWidget>
  ...
  <aliases>
    ...
    <alias index="2" field="identificador" name=""/>
    ...
    <alias index="7" field="tipoaglomrurisol" name=""/>
  </aliases>
  ...
  <defaults>
    ...
    <default applyOnUpdate="0" field="tipoaglomrurisol" expression=""/>
  </defaults>
  <constraints>
    ...
    <constraint unique_strength="0" field="tipoaglomrurisol" constraints="1" notnull_strength="1" exp_strength="0"/>
  </constraints>
  <constraintExpressions>
    ...
    <constraint desc="" exp="" field="tipoaglomrurisol"/>
  </constraintExpressions>
  <expressionfields/>
  <attributeactions/>

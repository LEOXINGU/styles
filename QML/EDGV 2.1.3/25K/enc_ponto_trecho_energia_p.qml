...
<qgis version="3.4.14-Madeira" minScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" simplifyLocal="1" simplifyDrawingHints="1" readOnly="0" styleCategories="AllStyleCategories" labelsEnabled="0" maxScale="0" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0">
        ...
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              ...
              <Option type="QString" value="1" name="Estação geradora de energia"/>
              <Option type="QString" value="4" name="Ponto de ramificação"/>
              <Option type="QString" value="3" name="Subestação de  distribuição"/>
              <Option type="QString" value="2" name="Subestação de transmissão"/>
            </Option>
          </Option>
        </config>
      </editWidget>
  ...
  <aliases>
    ...
    <alias index="2" field="tipoptoenergia" name=""/>
  </aliases>
  ...
  <defaults>
    ...
    <default applyOnUpdate="0" field="tipoptoenergia" expression=""/>
  </defaults>
  <constraints>
    ...
    <constraint unique_strength="0" field="tipoptoenergia" constraints="1" notnull_strength="1" exp_strength="0"/>
  </constraints>
  <constraintExpressions>
    <constraint desc="" exp="" field="id"/>
    <constraint desc="" exp="" field="geometriaaproximada"/>
    <constraint desc="" exp="" field="tipoptoenergia"/>
  </constraintExpressions>
  <expressionfields/>
  <attributeactions/>

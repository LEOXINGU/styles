...
<qgis version="3.4.14-Madeira" minScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" simplifyLocal="1" simplifyDrawingHints="1" readOnly="0" styleCategories="AllStyleCategories" labelsEnabled="0" maxScale="0" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0">
        ...
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              <Option type="QString" value="999" name="A SER PREENCHIDO"/>
              <Option type="QString" value="0" name="Desconhecido"/>
              <Option type="QString" value="10" name="Extração de Carvão Mineral"/>
              <Option type="QString" value="13" name="Extração de Minerais Metálicos"/>
              <Option type="QString" value="14" name="Extração de Minerais Não-Metálicos"/>
              <Option type="QString" value="11" name="Extração de Petróleo e Serviços Relacionados"/>
              <Option type="QString" value="99" name="Outros"/>
            </Option>
          </Option>
        </config>
  ...
  <aliases>
    ...
    <alias index="7" field="tipodivisaocnae" name=""/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" field="tipodivisaocnae" constraints="1" notnull_strength="1" exp_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint desc="" exp="" field="tipodivisaocnae"/>

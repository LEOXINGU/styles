...
<qgis version="3.4.14-Madeira" minScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" simplifyLocal="1" simplifyDrawingHints="1" readOnly="0" styleCategories="AllStyleCategories" labelsEnabled="0" maxScale="0" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0">
      ...
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              <Option type="QString" value="999" name="A SER PREENCHIDO"/>
              <Option type="QString" value="11" name="Heliporto"/>
              <Option type="QString" value="9" name="Pista de pouso"/>
              <Option type="QString" value="10" name="Pista de táxi"/>
            </Option>
          </Option>
        </config>
      </editWidget>
        ...
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              ...
              <Option type="QString" value="13" name="Público/Militar"/>
            </Option>
          </Option>
        </config>
      </editWidget>
  ...
  <aliases>
    ...
    <alias index="3" field="homologacao" name=""/>
    ...
    <alias index="8" field="revestimento" name=""/>
    <alias index="9" field="situacaofisica" name=""/>
    <alias index="10" field="tipopista" name=""/>
    <alias index="11" field="usopista" name=""/>

...
<qgis version="3.4.14-Madeira" minScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" simplifyLocal="1" simplifyDrawingHints="1" readOnly="0" styleCategories="AllStyleCategories" labelsEnabled="0" maxScale="0" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0">
        ...
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              ...
              <Option type="QString" value="0" name="Desconhecido"/>
              <Option type="QString" value="8" name="Sempre fora d´água"/>
              <Option type="QString" value="9" name="Sempre submerso"/>
            </Option>
          </Option>
        </config>
      </editWidget>
    </field>
    <field name="tipoquebramolhe">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              <Option type="QString" value="999" name="A SER PREENCHIDO"/>
              <Option type="QString" value="0" name="Desconhecido"/>
              <Option type="QString" value="2" name="Molhe"/>
              <Option type="QString" value="1" name="Quebramar"/>
            </Option>
          </Option>
        </config>
      </editWidget>
  ...
  <aliases>
    ...
    <alias index="7" field="situamare" name=""/>
    <alias index="8" field="tipoquebramolhe" name=""/>
  ...
  <defaults>
    ...
    <default applyOnUpdate="0" field="situamare" expression=""/>
    <default applyOnUpdate="0" field="tipoquebramolhe" expression=""/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" field="situamare" constraints="1" notnull_strength="1" exp_strength="0"/>
    <constraint unique_strength="0" field="tipoquebramolhe" constraints="1" notnull_strength="1" exp_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint desc="" exp="" field="situamare"/>
    <constraint desc="" exp="" field="tipoquebramolhe"/>

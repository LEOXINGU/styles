...
<qgis version="3.4.14-Madeira" minScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" simplifyLocal="1" simplifyDrawingHints="1" readOnly="0" styleCategories="AllStyleCategories" labelsEnabled="0" maxScale="0" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0">
        ...
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              ...
              <Option type="QString" value="0" name="Desconhecido"/>
              <Option type="QString" value="99" name="Outros"/>
              <Option type="QString" value="10" name="Parada interestadual"/>
              <Option type="QString" value="14" name="Posto de fiscalização"/>
              <Option type="QString" value="13" name="Posto de pedágio"/>
              <Option type="QString" value="12" name="Posto de pesagem"/>
              <Option type="QString" value="8" name="Terminal interestadual"/>
              <Option type="QString" value="9" name="Terminal urbano"/>
            </Option>
          </Option>
        </config>
      </editWidget>
  ...
  <aliases>
    ...
    <alias index="8" field="tipoedifrod" name=""/>

...
<qgis version="3.4.14-Madeira" minScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" simplifyLocal="1" simplifyDrawingHints="1" readOnly="0" styleCategories="AllStyleCategories" labelsEnabled="0" maxScale="0" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0">
        ...
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              <Option type="QString" value="999" name="A SER PREENCHIDO"/>
              <Option type="QString" value="0" name="Desconhecido"/>
              <Option type="QString" value="5" name="Primário"/>
              <Option type="QString" value="6" name="Secundário"/>
              <Option type="QString" value="7" name="Terciário"/>
            </Option>
          </Option>
        </config>
      </editWidget>
    ...
    <field name="tipoclassecnae">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              <Option type="QString" value="26" name="85.11-1 Atendimento Hospitalar (Hospital)"/>
              <Option type="QString" value="27" name="85.12-0 Atendimento a Urgência e Emergências (Pronto Socorro)"/>
              <Option type="QString" value="28" name="85.13-8 Atenção Ambulatorial (Posto e Centro de Saúde)"/>
              <Option type="QString" value="29" name="85.14-6 Serviços de Complementação Diagnóstica ou Terapêutica"/>
              <Option type="QString" value="30" name="85.16-2 Outras Atividades Relacionadas com a Atenção à Saúde (Instituto de Pesquisa)"/>
              <Option type="QString" value="31" name="85.20-0 Serviços Veterinários"/>
              <Option type="QString" value="999" name="A SER PREENCHIDO"/>
              <Option type="QString" value="0" name="Desconhecido"/>
  ...
  <aliases>
    ...
    <alias index="3" field="nivelatencao" name=""/>
    ...
    <alias index="8" field="tipoclassecnae" name=""/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" field="nivelatencao" constraints="1" notnull_strength="1" exp_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint desc="" exp="" field="nivelatencao"/>

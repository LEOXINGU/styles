...
<qgis version="3.4.14-Madeira" minScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" simplifyLocal="1" simplifyDrawingHints="1" readOnly="0" styleCategories="AllStyleCategories" labelsEnabled="0" maxScale="0" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0">
      ...
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              <Option type="QString" value="999" name="A SER PREENCHIDO"/>
              <Option type="QString" value="3" name="Bosque"/>
              <Option type="QString" value="0" name="Desconhecido"/>
              <Option type="QString" value="1" name="Floresta"/>
              <Option type="QString" value="2" name="Mata"/>
            </Option>
          </Option>
        </config>
      </editWidget>
      ...
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              <Option type="QString" value="999" name="A SER PREENCHIDO"/>
              <Option type="QString" value="2" name="Arbustiva"/>
              <Option type="QString" value="1" name="Arbórea"/>
              <Option type="QString" value="0" name="Desconhecido"/>
      ...
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              <Option type="QString" value="999" name="A SER PREENCHIDO"/>
              <Option type="QString" value="27" name="Araucária"/>
              <Option type="QString" value="41" name="Babaçu"/>
              <Option type="QString" value="11" name="Bambu"/>
              <Option type="QString" value="10" name="Cipó"/>
              <Option type="QString" value="98" name="Misto"/>
              <Option type="QString" value="96" name="Não identificado"/>
              <Option type="QString" value="17" name="Palmeira"/>
              <Option type="QString" value="12" name="Sororoca"/>
            </Option>
          </Option>
        </config>
      </editWidget>
  ...
  <aliases>
    ...
    <alias index="1" field="alturamediaindividuos" name=""/>
    <alias index="2" field="antropizada" name=""/>
    <alias index="3" field="caracteristicafloresta" name=""/>
    <alias index="4" field="classificacaoporte" name=""/>
    <alias index="5" field="denso" name=""/>
    <alias index="6" field="especiepredominante" name=""/>
    <alias index="7" field="geometriaaproximada" name=""/>
    <alias index="8" field="nome" name=""/>
    <alias index="9" field="nomeabrev" name=""/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" field="alturamediaindividuos" constraints="0" notnull_strength="0" exp_strength="0"/>
    <constraint unique_strength="0" field="antropizada" constraints="1" notnull_strength="1" exp_strength="0"/>
    <constraint unique_strength="0" field="caracteristicafloresta" constraints="1" notnull_strength="1" exp_strength="0"/>
    <constraint unique_strength="0" field="classificacaoporte" constraints="1" notnull_strength="1" exp_strength="0"/>
    <constraint unique_strength="0" field="denso" constraints="1" notnull_strength="1" exp_strength="0"/>
    <constraint unique_strength="0" field="especiepredominante" constraints="1" notnull_strength="1" exp_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint desc="" exp="" field="alturamediaindividuos"/>
    <constraint desc="" exp="" field="antropizada"/>
    <constraint desc="" exp="" field="caracteristicafloresta"/>
    <constraint desc="" exp="" field="classificacaoporte"/>
    <constraint desc="" exp="" field="denso"/>
    <constraint desc="" exp="" field="especiepredominante"/>

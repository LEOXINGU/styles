...
<qgis version="3.4.14-Madeira" minScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" simplifyLocal="1" simplifyDrawingHints="1" readOnly="0" styleCategories="AllStyleCategories" labelsEnabled="0" maxScale="0" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0">
  ...
  <aliases>
    ...
    <alias index="2" field="bitola" name=""/>
    <alias index="3" field="cargasuportmaxima" name=""/>
    <alias index="4" field="codtrechoferrov" name=""/>
    <alias index="5" field="concessionaria" name=""/>
    <alias index="6" field="eletrificada" name=""/>
    <alias index="7" field="emarruamento" name=""/>
    <alias index="8" field="geometriaaproximada" name=""/>
    <alias index="9" field="jurisdicao" name=""/>
    <alias index="10" field="nome" name=""/>
    <alias index="11" field="nomeabrev" name=""/>
    <alias index="12" field="nrlinhas" name=""/>
    <alias index="13" field="operacional" name=""/>
    <alias index="14" field="posicaorelativa" name=""/>
    <alias index="15" field="situacaofisica" name=""/>
    <alias index="16" field="tipotrechoferrov" name=""/>

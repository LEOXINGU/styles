...
<qgis version="3.4.14-Madeira" minScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" simplifyLocal="1" simplifyDrawingHints="1" readOnly="0" styleCategories="AllStyleCategories" labelsEnabled="0" maxScale="0" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0">
  ...
  <aliases>
    ...
    <alias index="2" field="canteirodivisorio" name=""/>
    <alias index="3" field="capaccarga" name=""/>
    <alias index="4" field="codtrechorodov" name=""/>
    <alias index="5" field="concessionaria" name=""/>
    <alias index="6" field="geometriaaproximada" name=""/>
    <alias index="7" field="jurisdicao" name=""/>
    <alias index="8" field="nrfaixas" name=""/>
    <alias index="9" field="nrpistas" name=""/>
    <alias index="10" field="operacional" name=""/>
    <alias index="11" field="revestimento" name=""/>
    <alias index="12" field="situacaofisica" name=""/>
    <alias index="13" field="tipotrechorod" name=""/>
    <alias index="14" field="trafego" name=""/>
    <alias index="15" field="lenght_otf" name=""/>
  </aliases>
  ...
  <defaults>
    ...
    <default applyOnUpdate="0" field="capaccarga" expression=""/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" field="capaccarga" constraints="0" notnull_strength="0" exp_strength="0"/>
    <constraint unique_strength="0" field="codtrechorodov" constraints="0" notnull_strength="0" exp_strength="0"/>
    ...
    <constraint unique_strength="0" field="tipotrechorod" constraints="1" notnull_strength="1" exp_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint desc="" exp="" field="capaccarga"/>

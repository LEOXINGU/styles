...
<qgis version="3.4.14-Madeira" minScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" simplifyLocal="1" simplifyDrawingHints="1" readOnly="0" styleCategories="AllStyleCategories" labelsEnabled="0" maxScale="0" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0">
      ...
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              <Option type="QString" value="999" name="A SER PREENCHIDO"/>
              <Option type="QString" value="14" name="Apiário"/>
              <Option type="QString" value="13" name="Aviário"/>
              <Option type="QString" value="18" name="Curral"/>
              <Option type="QString" value="0" name="Desconhecido"/>
              <Option type="QString" value="99" name="Outros"/>
              <Option type="QString" value="17" name="Pocilga"/>
              <Option type="QString" value="12" name="Sede operacional de fazenda"/>
              <Option type="QString" value="15" name="Viveiro de plantas"/>
              <Option type="QString" value="16" name="Viveiro para aquicultura"/>
            </Option>
          </Option>
        </config>
      </editWidget>
  ...
  <aliases>
    ...
    <alias index="7" field="tipoedifagropec" name=""/>
  </aliases>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" field="tipoedifagropec" constraints="1" notnull_strength="1" exp_strength="0"/>
  </constraints>
  <constraintExpressions>
    ...
    <constraint desc="" exp="" field="tipoedifagropec"/>
  </constraintExpressions>
  <expressionfields/>
  <attributeactions/>

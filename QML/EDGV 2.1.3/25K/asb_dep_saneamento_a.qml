...
<qgis version="3.4.14-Madeira" minScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" simplifyLocal="1" simplifyDrawingHints="1" readOnly="0" styleCategories="AllStyleCategories" labelsEnabled="0" maxScale="0" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0">
  ...
  <aliases>
    ...
    <alias index="1" field="construcao" name=""/>
    <alias index="2" field="finalidade" name=""/>
    ...
    <alias index="8" field="residuo" name=""/>
    <alias index="9" field="situacaofisica" name=""/>
    <alias index="10" field="tipodepsaneam" name=""/>
    <alias index="11" field="tiporesiduo" name=""/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" field="construcao" constraints="1" notnull_strength="1" exp_strength="0"/>
    ...
    <constraint unique_strength="0" field="residuo" constraints="1" notnull_strength="1" exp_strength="0"/>
    <constraint unique_strength="0" field="situacaofisica" constraints="1" notnull_strength="1" exp_strength="0"/>
    <constraint unique_strength="0" field="tipodepsaneam" constraints="1" notnull_strength="1" exp_strength="0"/>
    <constraint unique_strength="0" field="tiporesiduo" constraints="1" notnull_strength="1" exp_strength="0"/>
    <constraint unique_strength="0" field="area_otf" constraints="0" notnull_strength="0" exp_strength="0"/>
  </constraints>
  <constraintExpressions>
    <constraint desc="" exp="" field="id"/>
    <constraint desc="" exp="" field="construcao"/>
    ...
    <constraint desc="" exp="" field="residuo"/>
    <constraint desc="" exp="" field="situacaofisica"/>
    <constraint desc="" exp="" field="tipodepsaneam"/>
    <constraint desc="" exp="" field="tiporesiduo"/>

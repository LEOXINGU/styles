...
<qgis version="3.4.14-Madeira" minScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" simplifyLocal="1" simplifyDrawingHints="1" readOnly="0" styleCategories="AllStyleCategories" labelsEnabled="0" maxScale="0" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0">
        ...
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              ...
              <Option type="QString" value="18" name="Açaí"/>
              <Option type="QString" value="41" name="Babaçu"/>
              <Option type="QString" value="37" name="Carnaúba"/>
              <Option type="QString" value="36" name="Castanha"/>
              <Option type="QString" value="38" name="Coco"/>
              <Option type="QString" value="0" name="Desconhecido"/>
              <Option type="QString" value="39" name="Jaborandi"/>
              <Option type="QString" value="35" name="Látex"/>
              <Option type="QString" value="5" name="Madeira"/>
              <Option type="QString" value="99" name="Outros"/>
              <Option type="QString" value="40" name="Palmito"/>
              <Option type="QString" value="43" name="Pecuária"/>
              <Option type="QString" value="44" name="Pesca"/>
              <Option type="QString" value="34" name="Turfa"/>
            </Option>
          </Option>
        </config>
      </editWidget>
  ...
  <aliases>
    ...
    <alias index="1" field="destinadoa" name=""/>
    <alias index="2" field="geometriaaproximada" name=""/>
    <alias index="3" field="area_otf" name=""/>
  </aliases>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" field="destinadoa" constraints="1" notnull_strength="1" exp_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint desc="" exp="" field="destinadoa"/>

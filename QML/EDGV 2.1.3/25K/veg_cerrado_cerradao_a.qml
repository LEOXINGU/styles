...
<qgis version="3.4.14-Madeira" minScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" simplifyLocal="1" simplifyDrawingHints="1" readOnly="0" styleCategories="AllStyleCategories" labelsEnabled="0" maxScale="0" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0">
      ...
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              <Option type="QString" value="999" name="A SER PREENCHIDO"/>
              <Option type="QString" value="1" name="Cerrado"/>
              <Option type="QString" value="2" name="Cerradão"/>
              <Option type="QString" value="0" name="Desconhecido"/>
            </Option>
          </Option>
        </config>
  ...
  <aliases>
    ...
    <alias index="1" field="antropizada" name=""/>
    <alias index="2" field="alturamediaindividuos" name=""/>
    ...
    <alias index="8" field="tipocerr" name=""/>
  ...
  <defaults>
    ...
    <default applyOnUpdate="0" field="tipocerr" expression=""/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" field="tipocerr" constraints="1" notnull_strength="1" exp_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint desc="" exp="" field="tipocerr"/>

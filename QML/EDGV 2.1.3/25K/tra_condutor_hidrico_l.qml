...
<qgis version="3.4.14-Madeira" minScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" simplifyLocal="1" simplifyDrawingHints="1" readOnly="0" styleCategories="AllStyleCategories" labelsEnabled="0" maxScale="0" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0">
  ...
  <aliases>
    ...
    <alias index="3" field="mattransp" name=""/>
    <alias index="4" field="nrdutos" name=""/>
    ...
    <alias index="9" field="setor" name=""/>
    <alias index="10" field="situacaoespacial" name=""/>
    <alias index="11" field="situacaofisica" name=""/>
    <alias index="12" field="tipocondutor" name=""/>
    <alias index="13" field="lenght_otf" name=""/>
  </aliases>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" field="mattransp" constraints="1" notnull_strength="1" exp_strength="0"/>
    ...
    <constraint unique_strength="0" field="tipocondutor" constraints="1" notnull_strength="1" exp_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint desc="" exp="" field="tipocondutor"/>

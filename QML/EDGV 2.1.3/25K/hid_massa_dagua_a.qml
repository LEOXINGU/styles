...
<qgis version="3.4.14-Madeira" minScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" simplifyLocal="1" simplifyDrawingHints="1" readOnly="0" styleCategories="AllStyleCategories" labelsEnabled="0" maxScale="0" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0">
        ...
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              ...
              <Option type="QString" value="1" name="Doce"/>
              <Option type="QString" value="2" name="Salgada"/>
            </Option>
          </Option>
        </config>
      </editWidget>
        ...
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              ...
              <Option type="QString" value="7" name="Lago"/>
              <Option type="QString" value="8" name="Lagoa"/>
  ...
  <aliases>
    ...
    <alias index="5" field="salinidade" name=""/>
    <alias index="6" field="tipomassadagua" name=""/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" field="salinidade" constraints="1" notnull_strength="1" exp_strength="0"/>

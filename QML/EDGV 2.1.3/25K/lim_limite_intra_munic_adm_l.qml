...
<qgis version="3.4.14-Madeira" minScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" simplifyLocal="1" simplifyDrawingHints="1" readOnly="0" styleCategories="AllStyleCategories" labelsEnabled="0" maxScale="0" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0">
  ...
  <fieldConfiguration>
    ...
    <field name="tipolimintramun">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              <Option type="QString" value="999" name="A SER PREENCHIDO"/>
              <Option type="QString" value="5" name="Bairro"/>
              <Option type="QString" value="1" name="Distrital"/>
              <Option type="QString" value="3" name="Perímetro urbano legal"/>
              <Option type="QString" value="4" name="Região administrativa"/>
              <Option type="QString" value="2" name="Sub-distrital"/>
            </Option>
          </Option>
        </config>
      </editWidget>
  ...
  <aliases>
    ...
    <alias index="7" field="tipolimintramun" name=""/>
  ...
  <defaults>
    ...
    <default applyOnUpdate="0" field="tipolimintramun" expression=""/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" field="tipolimintramun" constraints="1" notnull_strength="1" exp_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint desc="" exp="" field="tipolimintramun"/>

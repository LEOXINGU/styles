...
<qgis version="3.4.14-Madeira" minScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" simplifyLocal="1" simplifyDrawingHints="1" readOnly="0" styleCategories="AllStyleCategories" labelsEnabled="0" maxScale="0" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0">
  ...
  <aliases>
    ...
    <alias index="1" field="altitudeortometrica" name=""/>
    <alias index="2" field="codponto" name=""/>
    <alias index="3" field="codprojeto" name=""/>
    <alias index="4" field="geometriaaproximada" name=""/>
    <alias index="5" field="latitude" name=""/>
    <alias index="6" field="longitude" name=""/>
    <alias index="7" field="materializado" name=""/>
    <alias index="8" field="nomeabrev" name=""/>
    <alias index="9" field="obs" name=""/>
    <alias index="10" field="orgaoenteresp" name=""/>
    <alias index="11" field="outrarefalt" name=""/>
    <alias index="12" field="outrarefplan" name=""/>
    <alias index="13" field="referencialaltim" name=""/>
    <alias index="14" field="sistemageodesico" name=""/>
    <alias index="15" field="tipoptocontrole" name=""/>
    <alias index="16" field="tiporef" name=""/>
  </aliases>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" field="codprojeto" constraints="0" notnull_strength="0" exp_strength="0"/>
    ...
    <constraint unique_strength="0" field="materializado" constraints="1" notnull_strength="1" exp_strength="0"/>
    ...
    <constraint unique_strength="0" field="tipoptocontrole" constraints="1" notnull_strength="1" exp_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint desc="" exp="" field="codprojeto"/>
    ...
    <constraint desc="" exp="" field="tipoptocontrole"/>

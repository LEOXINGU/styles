...
<qgis version="3.4.14-Madeira" minScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" simplifyLocal="1" simplifyDrawingHints="1" readOnly="0" styleCategories="AllStyleCategories" labelsEnabled="0" maxScale="0" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0">
  ...
  <fieldConfiguration>
    ...
    <field name="destinacaofundeadouro">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              ...
              <Option type="QString" value="11" name="Fundeadouro com designação alfanumérica"/>
              <Option type="QString" value="10" name="Fundeadouro recomendado sem limite definido"/>
              <Option type="QString" value="99" name="Outros"/>
              <Option type="QString" value="12" name="Áreas de fundeio com limite definido"/>
              <Option type="QString" value="13" name="Áreas de fundeio proibido"/>
            </Option>
          </Option>
        </config>
      </editWidget>
  ...
  <aliases>
    ...
    <alias index="2" field="destinacaofundeadouro" name=""/>
  ...
  <defaults>
    ...
    <default applyOnUpdate="0" field="destinacaofundeadouro" expression=""/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" field="destinacaofundeadouro" constraints="1" notnull_strength="1" exp_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint desc="" exp="" field="destinacaofundeadouro"/>

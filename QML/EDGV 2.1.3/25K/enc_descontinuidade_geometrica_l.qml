...
<qgis version="3.4.14-Madeira" minScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" simplifyLocal="1" simplifyDrawingHints="1" readOnly="0" styleCategories="AllStyleCategories" labelsEnabled="0" maxScale="0" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0">
        ...
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              ...
              <Option type="QString" value="1" name="Descontinuidade Temporal"/>
              <Option type="QString" value="2" name="Descontinuidade devido a transformação"/>
              <Option type="QString" value="5" name="Descontinuidade por diferente interpretação das classes"/>
              <Option type="QString" value="3" name="Descontinuidade por escala de insumo"/>
              <Option type="QString" value="7" name="Descontinuidade por excesso"/>
              <Option type="QString" value="4" name="Descontinuidade por falta de acurácia"/>
              <Option type="QString" value="6" name="Descontinuidade por omissão"/>
            </Option>
          </Option>
        </config>
      </editWidget>
  ...
  <aliases>
    ...
    <alias index="1" field="motivodescontinuidade" name=""/>
    <alias index="2" field="lenght_otf" name=""/>
  </aliases>

      ...
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              <Option type="QString" value="999" name="A SER PREENCHIDO"/>
              <Option type="QString" value="4" name="Depósito geral"/>
              <Option type="QString" value="17" name="Interrupção com a Moldura"/>
              <Option type="QString" value="3" name="Local crítico"/>
              <Option type="QString" value="5" name="Ponto de ramificação"/>
              <Option type="QString" value="2" name="Ponto final"/>
              <Option type="QString" value="1" name="Ponto inicial"/>
            </Option>
          </Option>
        </config>
      </editWidget>

...
<qgis version="3.4.14-Madeira" minScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" simplifyLocal="1" simplifyDrawingHints="1" readOnly="0" styleCategories="AllStyleCategories" labelsEnabled="0" maxScale="0" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0">
        ...
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              ...
              <Option type="QString" value="4" name="Interferência com hidrografia"/>
              <Option type="QString" value="3" name="Interferência com localidades"/>
              <Option type="QString" value="6" name="Interferência com vias"/>
              <Option type="QString" value="5" name="Interferência com áreas especiais"/>
              <Option type="QString" value="7" name="Outras interferências"/>
              <Option type="QString" value="2" name="Risco geotécnico"/>
              <Option type="QString" value="1" name="Subestação de válvulas e/ou bombas"/>
            </Option>
          </Option>
        </config>
      </editWidget>
  ...
  <aliases>
    ...
    <alias index="4" field="tipolocalcrit" name=""/>
    <alias index="5" field="lenght_otf" name=""/>
  </aliases>
  ...
  <defaults>
    ...
    <default applyOnUpdate="0" field="tipolocalcrit" expression=""/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" field="tipolocalcrit" constraints="1" notnull_strength="1" exp_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint desc="" exp="" field="tipolocalcrit"/>

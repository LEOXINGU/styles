...
<qgis version="3.4.14-Madeira" minScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" simplifyLocal="1" simplifyDrawingHints="1" readOnly="0" styleCategories="AllStyleCategories" labelsEnabled="0" maxScale="0" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0">
  ...
  <aliases>
    ...
    <alias index="1" field="calado" name=""/>
    <alias index="2" field="desnivel" name=""/>
    <alias index="3" field="extensao" name=""/>
    <alias index="4" field="geometriaaproximada" name=""/>
    <alias index="5" field="largura" name=""/>
    <alias index="6" field="matconstr" name=""/>
    <alias index="7" field="nome" name=""/>
    <alias index="8" field="nomeabrev" name=""/>
    <alias index="9" field="operacional" name=""/>
    <alias index="10" field="situacaofisica" name=""/>
  ...
  <defaults>
    ...
    <default applyOnUpdate="0" field="calado" expression=""/>
    <default applyOnUpdate="0" field="desnivel" expression=""/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" field="calado" constraints="0" notnull_strength="0" exp_strength="0"/>
    <constraint unique_strength="0" field="desnivel" constraints="0" notnull_strength="0" exp_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint desc="" exp="" field="calado"/>
    <constraint desc="" exp="" field="desnivel"/>

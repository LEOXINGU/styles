        ...
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              ...
              <Option type="QString" value="3" name="Absorção"/>
              <Option type="QString" value="1" name="Canalização"/>
              <Option type="QString" value="0" name="Desconhecida"/>
              <Option type="QString" value="2" name="Gruta ou Fenda"/>
            </Option>
          </Option>
        </config>
      </editWidget>

...
<qgis version="3.4.14-Madeira" minScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" simplifyLocal="1" simplifyDrawingHints="1" readOnly="0" styleCategories="AllStyleCategories" labelsEnabled="0" maxScale="0" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0">
  ...
  <fieldConfiguration>
    ...
    <field name="namaximooperacional">
      <editWidget type="">
        <config>
          <Option/>
        </config>
  ...
  <aliases>
    ...
    <alias index="2" field="namaximomaximorum" name=""/>
    <alias index="3" field="namaximooperacional" name=""/>
    <alias index="4" field="nome" name=""/>
    <alias index="5" field="nomeabrev" name=""/>
    <alias index="6" field="usoprincipal" name=""/>
    <alias index="7" field="volumeutil" name=""/>
  ...
  <defaults>
    ...
    <default applyOnUpdate="0" field="namaximomaximorum" expression=""/>
    <default applyOnUpdate="0" field="namaximooperacional" expression=""/>
    <default applyOnUpdate="0" field="nome" expression=""/>
    <default applyOnUpdate="0" field="nomeabrev" expression=""/>
    <default applyOnUpdate="0" field="usoprincipal" expression=""/>
    <default applyOnUpdate="0" field="volumeutil" expression=""/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" field="namaximomaximorum" constraints="0" notnull_strength="0" exp_strength="0"/>
    <constraint unique_strength="0" field="namaximooperacional" constraints="0" notnull_strength="0" exp_strength="0"/>
    ...
    <constraint unique_strength="0" field="volumeutil" constraints="0" notnull_strength="0" exp_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint desc="" exp="" field="namaximomaximorum"/>
    <constraint desc="" exp="" field="namaximooperacional"/>
    <constraint desc="" exp="" field="nome"/>
    <constraint desc="" exp="" field="nomeabrev"/>
    <constraint desc="" exp="" field="usoprincipal"/>
    <constraint desc="" exp="" field="volumeutil"/>

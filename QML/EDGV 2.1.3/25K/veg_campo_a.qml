...
<qgis version="3.4.14-Madeira" minScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" simplifyLocal="1" simplifyDrawingHints="1" readOnly="0" styleCategories="AllStyleCategories" labelsEnabled="0" maxScale="0" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0">
  ...
  <fieldConfiguration>
    ...
    <field name="ocorrenciaem">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              <Option type="QString" value="999" name="A SER PREENCHIDO"/>
              <Option type="QString" value="5" name="Brejo ou Pântano"/>
              <Option type="QString" value="6" name="Caatinga"/>
              <Option type="QString" value="19" name="Campinarana"/>
              <Option type="QString" value="13" name="Cerrado ou cerradão"/>
              <Option type="QString" value="7" name="Estepe"/>
              <Option type="QString" value="15" name="Floresta"/>
              <Option type="QString" value="14" name="Macega ou chavascal"/>
              <Option type="QString" value="96" name="Não Identificado"/>
              <Option type="QString" value="8" name="Pastagem"/>
            </Option>
          </Option>
        </config>
      </editWidget>
  ...
  <aliases>
    ...
    <alias index="4" field="ocorrenciaem" name=""/>
    <alias index="5" field="tipocampo" name=""/>
  ...
  <defaults>
    ...
    <default applyOnUpdate="0" field="ocorrenciaem" expression=""/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" field="ocorrenciaem" constraints="1" notnull_strength="1" exp_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint desc="" exp="" field="ocorrenciaem"/>

...
<qgis version="3.4.14-Madeira" minScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" simplifyLocal="1" simplifyDrawingHints="1" readOnly="0" styleCategories="AllStyleCategories" labelsEnabled="0" maxScale="0" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0">
        ...
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              ...
              <Option type="QString" value="36" name="Carreira"/>
              <Option type="QString" value="0" name="Desconhecido"/>
              <Option type="QString" value="34" name="Dique de estaleiro"/>
              <Option type="QString" value="33" name="Estaleiro"/>
              <Option type="QString" value="99" name="Outros"/>
              <Option type="QString" value="35" name="Rampa"/>
              <Option type="QString" value="27" name="Terminal de cargas"/>
              <Option type="QString" value="26" name="Terminal de passageiros"/>
              <Option type="QString" value="37" name="Terminal privativo"/>
            </Option>
          </Option>
        </config>
      </editWidget>
  ...
  <aliases>
    ...
    <alias index="8" field="tipoedifport" name=""/>

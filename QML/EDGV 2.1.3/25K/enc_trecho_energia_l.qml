...
<qgis version="3.4.14-Madeira" minScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" simplifyLocal="1" simplifyDrawingHints="1" readOnly="0" styleCategories="AllStyleCategories" labelsEnabled="0" maxScale="0" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0">
        ...
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              ...
              <Option type="QString" value="3" name="Distribuição"/>
              <Option type="QString" value="2" name="Transmissão"/>
            </Option>
          </Option>
        </config>
      </editWidget>
  ...
  <aliases>
    ...
    <alias index="1" field="emduto" name=""/>
    <alias index="2" field="especie" name=""/>
    <alias index="3" field="geometriaaproximada" name=""/>
    <alias index="4" field="nome" name=""/>
    <alias index="5" field="nomeabrev" name=""/>
    <alias index="6" field="numcircuitos" name=""/>
    <alias index="7" field="operacional" name=""/>
    <alias index="8" field="posicaorelativa" name=""/>
    <alias index="9" field="situacaofisica" name=""/>
    <alias index="10" field="tensaoeletrica" name=""/>
    <alias index="11" field="lenght_otf" name=""/>
  </aliases>
  ...
  <defaults>
    ...
    <default applyOnUpdate="0" field="especie" expression=""/>
    <default applyOnUpdate="0" field="geometriaaproximada" expression=""/>
    <default applyOnUpdate="0" field="nome" expression=""/>
    <default applyOnUpdate="0" field="nomeabrev" expression=""/>
    <default applyOnUpdate="0" field="numcircuitos" expression=""/>
    ...
    <default applyOnUpdate="0" field="tensaoeletrica" expression=""/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" field="emduto" constraints="1" notnull_strength="1" exp_strength="0"/>
    <constraint unique_strength="0" field="especie" constraints="1" notnull_strength="1" exp_strength="0"/>
    ...
    <constraint unique_strength="0" field="numcircuitos" constraints="0" notnull_strength="0" exp_strength="0"/>

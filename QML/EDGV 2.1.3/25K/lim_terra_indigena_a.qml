...
<qgis version="3.4.14-Madeira" minScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" simplifyLocal="1" simplifyDrawingHints="1" readOnly="0" styleCategories="AllStyleCategories" labelsEnabled="0" maxScale="0" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0">
  ...
  <aliases>
    ...
    <alias index="1" field="areaoficialha" name=""/>
    <alias index="2" field="datasituacaojuridica" name=""/>
    <alias index="3" field="geometriaaproximada" name=""/>
    <alias index="4" field="grupoetnico" name=""/>
    <alias index="5" field="nome" name=""/>
    <alias index="6" field="nomeabrev" name=""/>
    <alias index="7" field="nometi" name=""/>
    <alias index="8" field="perimetrooficial" name=""/>
    <alias index="9" field="situacaojuridica" name=""/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" field="areaoficialha" constraints="0" notnull_strength="0" exp_strength="0"/>
    ...
    <constraint unique_strength="0" field="nometi" constraints="0" notnull_strength="0" exp_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint desc="" exp="" field="areaoficialha"/>
    ...
    <constraint desc="" exp="" field="nometi"/>

...
<qgis version="3.4.14-Madeira" minScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" simplifyLocal="1" simplifyDrawingHints="1" readOnly="0" styleCategories="AllStyleCategories" labelsEnabled="0" maxScale="0" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0">
      ...
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              <Option type="QString" value="999" name="A SER PREENCHIDO"/>
              <Option type="QString" value="4" name="Costa visível da carta(interpretada)"/>
              <Option type="QString" value="0" name="Desconhecido"/>
              <Option type="QString" value="2" name="Linha de base normal"/>
              <Option type="QString" value="3" name="Linha de base reta"/>
              <Option type="QString" value="6" name="Linha média de enchente-ORD"/>
              <Option type="QString" value="5" name="Linha preamar média - 1831"/>
              <Option type="QString" value="1" name="Setor censitário"/>
            </Option>
          </Option>
        </config>
      </editWidget>
  ...
  <aliases>
    ...
    <alias index="7" field="tipolimoper" name=""/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" field="tipolimoper" constraints="1" notnull_strength="1" exp_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint desc="" exp="" field="tipolimoper"/>

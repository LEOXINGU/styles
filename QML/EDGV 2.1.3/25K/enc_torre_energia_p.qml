...
<qgis version="3.4.14-Madeira" minScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" simplifyLocal="1" simplifyDrawingHints="1" readOnly="0" styleCategories="AllStyleCategories" labelsEnabled="0" maxScale="0" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0">
      ...
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              <Option type="QString" value="999" name="A SER PREENCHIDO"/>
              <Option type="QString" value="1" name="Autoportante"/>
              <Option type="QString" value="0" name="Desconhecido"/>
              <Option type="QString" value="2" name="Estaiada"/>
            </Option>
          </Option>
        </config>
      </editWidget>
  ...
  <aliases>
    ...
    <alias index="1" field="alturaestimada" name=""/>
    <alias index="2" field="arranjofases" name=""/>
    ...
    <alias index="7" field="ovgd" name=""/>
    <alias index="8" field="situacaofisica" name=""/>
    <alias index="9" field="tipotorre" name=""/>
  </aliases>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" field="arranjofases" constraints="0" notnull_strength="0" exp_strength="0"/>
    ...
    <constraint unique_strength="0" field="tipotorre" constraints="1" notnull_strength="1" exp_strength="0"/>
  </constraints>
  <constraintExpressions>
    <constraint desc="" exp="" field="id"/>
    <constraint desc="" exp="" field="alturaestimada"/>
    <constraint desc="" exp="" field="arranjofases"/>
    ...
    <constraint desc="" exp="" field="tipotorre"/>
  </constraintExpressions>
  <expressionfields/>
  <attributeactions/>

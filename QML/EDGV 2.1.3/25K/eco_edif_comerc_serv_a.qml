...
<qgis version="3.4.14-Madeira" minScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" simplifyLocal="1" simplifyDrawingHints="1" readOnly="0" styleCategories="AllStyleCategories" labelsEnabled="0" maxScale="0" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0">
      ...
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              <Option type="QString" value="999" name="A SER PREENCHIDO"/>
              <Option type="QString" value="3" name="Centro comercial"/>
              <Option type="QString" value="5" name="Centro de convenções"/>
              <Option type="QString" value="0" name="Desconhecido"/>
              <Option type="QString" value="6" name="Feira"/>
              <Option type="QString" value="7" name="Hotel/motel/pousada"/>
              <Option type="QString" value="4" name="Mercado"/>
              <Option type="QString" value="99" name="Outros"/>
              <Option type="QString" value="8" name="Restaurante"/>
            </Option>
          </Option>
        </config>
      </editWidget>
  ...
  <aliases>
    ...
    <alias index="1" field="finalidade" name=""/>
    ...
    <alias index="8" field="tipoedifcomercserv" name=""/>
